...
<?php } ?>		
		...
		function getAlarm()
		{
			...
			jQuery.post("<?=base_url()?>transporter/ppi_hourmeter/get_stnk_alert", {},
				function(data)
				{
					//alert(data.notification);
					jQuery("#stnk_notification").html(data.notification);
					g_notifready = true;
				}
				, "json"
			...
			jQuery.post("<?=base_url()?>transporter/ppi_hourmeter/get_kir_alert", {},
				function(data)
				{
					//alert(data.notification);
					jQuery("#kir_notification").html(data.notification);
					g_notifready = true;
				}
				, "json"
			...
			jQuery.post("<?=base_url()?>transporter/ppi_hourmeter/get_hm_alert", {},
				function(data)
				{
					//alert(data.notification);
					jQuery("#hm_notification").html(data.notification);
					g_notifready = true;
				}
				, "json"
			...
			<?php if ($this->sess->user_type != 4)  { ?>
				...
				<li id="write_active" class="write current" style="display: none;">
			        ...
			        <ul class="subnav"> 
						...
						<li><a href="<?=base_url();?>report/mn_history_hourmeter_ppi"><?="History Hour Meter";?></a></li>
				...
				<?php echo "Manage"; ?></a>
			        <ul class="subnav">
						...
						<?php } ?>
						<?php if ($this->sess->user_group == 0) { ?>
						<li><a href="<?=base_url();?>transporter/ppi_hourmeter">Data Hourmeter</a></li>
						<li><a href="<?=base_url();?>transporter/ppi_hourmeter/total_hourmeter">Total Hourmeter</a></li>
						<!--<li><a href="<?=base_url();?>transporter/ppi_hourmeter/config">Config Hourmeter</a></li>-->
						<li><a href="<?=base_url();?>transporter/ppi_hourmeter/alert">Alert Hourmeter</a></li>
						<li><a href="<?=base_url();?>transporter/ppi_hourmeter/service">Data Service</a></li>
						<?php } ?>
			        </ul> 
			    </li>
			<!--
 ...
 <!-- Status bar -->
	<div id="status-bar"><div class="container_12">
		...
		<ul id="status-infos">
            ...
            <!-- end Speed alert-->
			<li>
				<a class="button" title="HM Alert">
                <img src="<?php echo base_url();?>assets/newfarrasindo/images/icons/fugue/balloon.png" width="16" height="16" />
                <label id="hm_notification"></label></a></a>
				
			</li>
            <li>
				<a class="button" title="STNK Alert">
                <img src="<?php echo base_url();?>assets/newfarrasindo/images/icons/fugue/balloon.png" width="16" height="16" />
                <label id="stnk_notification"></label></a></a>
				
			</li>
			<li>
				<a class="button" title="KIR Alert">
                <img src="<?php echo base_url();?>assets/newfarrasindo/images/icons/fugue/balloon.png" width="16" height="16" />
                <label id="kir_notification"></label></a></a>
        ...
        <ul id="breadcrumb">
			<li>Live Support</li>
            	...
            	<a href="ymsgr:sendIM?ayu_lacakmobil" class="button" title="Rico">
            		<img border="0" src="http://opi.yahoo.com/online?u=ayu_lacakmobil&amp;m=g&amp;t=1"/>
				</a>
				...
				<a href="ymsgr:sendIM?robi_lacakmobil" class="button" title="Ayu">
            			<img border="0" src="http://opi.yahoo.com/online?u=robi_lacakmobil&amp;m=g&amp;t=1"/>
				</a>
				<a href="ymsgr:sendIM?hadi_lacakmobil" class="button" title="Rico">
