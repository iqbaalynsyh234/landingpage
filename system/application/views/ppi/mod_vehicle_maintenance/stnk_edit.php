...
function frmedit_onsubmit()
	{
		jQuery("#loader").show();
		jQuery.post("<?=base_url()?>transporter/ppi_mod_vehicle_maintenance/stnk_update/", jQuery("#frmedit").serialize(),	
			function(r)
			{
				jQuery("#loader").hide();
				if (r.error)
		...
		<table width="100%" cellpadding="3" class="table sortable no-margin" style="margin: 3px;">
			...
			<tr>
				...
				<td width="2%">:</td>
				<td>
					<input type='text' readonly name="mobil_stnk_expired"  id="mobil_stnk_expired" maxlength='10' style="width:150px;" value="<?=isset($row) ? htmlspecialchars($row->mobil_stnk_expired, ENT_QUOTES) : "";?>" class="formdefault" />
				</td>
			</tr>
			<tr>
				<td colspan="6">
