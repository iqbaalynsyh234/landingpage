<script>
	...
	{
		jQuery("#loader2").show();
		jQuery.post("<?=base_url()?>transporter/tupperware/set_loading", jQuery("#frmset").serialize(),
			function(r)
			{
				jQuery("#loader2").hide();
				if (r.error)
...
<div id="main_data">
		...
		<table width="100%" cellpadding="3" class="table sortable no-margin" style="margin: 3px;">
				...
				<tr>
					<td style="text-align:left" colspan="2"><h2>ID Booking ( Set To Loading )</h2></td>
				</tr>
				<tr>
				...
				<tr>
					<td style="text-align:right">Loading Date</td>
					<td>
						<input type="text" name="set_loading" id="set_loading" class="date-pick" />
					</td>
				</tr>
				<tr>
					<td style="text-align:right">Loading Time</td>
					<td>
						<select name="loading_time" id="loading_time" >
							<?php 
				...
				<tr>
					<td>&nbsp;</td>
					<td>
						<input type="submit" name="submit" id="submit" value="Set to Loading" />
