        ...
        <a name="atop"></a>
			...
			<?php if ($this->sess->user_type != 4)  { ?>
				...
				<li id="write_active" class="write current" style="display: none;">
				    ...
				    <!--update shu -->
				    <li><a href="<?=base_url();?>report/mn_last_location"><?="Last Location Detail";?></a></li>	
	...
	<div id="status-bar"><div class="container_12">
        ...
        <ul id="breadcrumb">
			<li>Live Support</li>
				...
				<a href="ymsgr:sendIM?jtriyadi1981" class="button">
					<img  border="0" src="http://opi.yahoo.com/online?u=jtriyadi1981&amp;m=g&amp;t=1"/>
				</a>
				<a href="ymsgr:sendIM?khanza_audah" class="button">
					<img border="0" src="http://opi.yahoo.com/online?u=khanza_audah&amp;m=g&amp;t=1"/>
				</a>
				<a href="ymsgr:sendIM?eddiegunasadhega" class="button">
					<img border="0" src="http://opi.yahoo.com/online?u=eddiegunasadhega&amp;m=g&amp;t=1"/>
				</a>
		</ul>
