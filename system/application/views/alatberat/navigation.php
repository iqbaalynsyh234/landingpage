			...
			<?php if ($this->sess->user_type != 4)  { ?>
				...
				<li id="write_active" class="write current" style="display: none;">
			        ...
			        <ul class="subnav"> 
						...
						<li><a href="<?=base_url();?>report/mn_hourmeter"><?="Hourmeter Report";?></a></li>
        ...
        <ul id="breadcrumb">
			...
			?>
				<a href="ymsgr:sendIM?nedi_lacakmobil" class="button" title="Nedi">
           			...
           			<a href="ymsgr:sendIM?ika_lacakmobil" class="button" title="Ika">
				...
				<a href="ymsgr:sendIM?erlan_lacakmobil" class="button" title="Erlan">
