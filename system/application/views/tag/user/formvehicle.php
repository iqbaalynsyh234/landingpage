	...
	jQuery.maxZIndex = jQuery.fn.maxZIndex = function(opt) {
        ...
        function loadgroup()
        {
				...
				{
					jQuery.post("<?=base_url();?>transporter/user/savevehicle_tag", jQuery("#frmaddvehicle").serialize(),
						function(r)
						{
							if (r.error)
							{
			...
			<form id="frmaddvehicle" onsubmit="javascript: return frmaddvehicle_onsubmit(this)">			
				...
				<input type="hidden" name="vehicle_no_old" id="vehicle_no_old" value="<?php if (isset($vehicle)) { echo $vehicle->vehicle_no; } ?>" />
				<input type="hidden" name="vehicle_name_old" id="vehicle_name_old" value="<?php if (isset($vehicle)) { echo $vehicle->vehicle_name; } ?>" />
			...
			<tr id="trowner">
				...
				<select name="vehicle_user_id" id="vehicle_user_id">
					...
					<tr>
						<td>Info Vehicle</td>
						<td>:</td>
						<td><?php if (isset($vehicle)) { echo $vehicle->vehicle_no; } ?> <?php if (isset($vehicle)) { echo $vehicle->vehicle_name; } ?></td>
					</tr>
					<tr>
						<td><font color="red">Note: Isi Kolom Kosong, jika ada perubahan Data</font></td>
					</tr>
					<tr>
						<td>No. Body</td>
						<td>:</td>
						<td><input type="text" name="vehicle_lm_new" id="vehicle_lm_new" value="" class="formdefault" placeholder="" size="10" /></td>
					</tr>
					<tr>
						<td>No. Vehicle</td>
						<td>:</td>
						<td><input type="text" name="vehicle_no_new" id="vehicle_no_new" value="" class="formdefault" placeholder="" /></td>
					</tr>
					<tr>
						<td>Vehicle Name</td>
						<td>:</td>
						<td><input type="text" name="vehicle_name_new" id="vehicle_name_new" value="" class="formdefault" placeholder="" /></td>
					</tr>					
				<?php if (($this->sess->user_type == 1) || (($this->sess->user_type == 3) && ($this->sess->agent_canedit_vactive == 1))) { ?>
    			<tr>
