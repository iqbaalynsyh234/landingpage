			...
			<?php if ($this->sess->user_group == 0) { ?>
				...
				<li id="write_active" class="write current" style="display: none;">
			        ...
			        <ul class="subnav">
						...
						<li><a href="<?=base_url();?>operational_report/door"><?="Door Report";?></a></li>
						<?php } ?>
	 ...
	 <?php } ?>
				...
				<li class="backup current" id="download_active" style="display: none;">
					...
					<ul>
                        ...
                        <!--<li><a href="<?=base_url();?>download/mn_download">Daily Report TES</a></li>-->
						<li><a href="http://lacak-mobil.com/assets/downloads/lacakmobil.apk" target='_blank'>Download Aplikasi Android</a></li>
