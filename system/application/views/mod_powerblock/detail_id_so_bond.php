			...
			<table width="100%" cellpadding="3" class="table sortable no-margin" style="margin: 3px;">
				...
				<tr>
					<td style="text-align:center" colspan="2">
						<h2>SURAT JALAN SO BOND( DETAIL )</h2>
				...
				<tr>
					<td style="text-align:left">SURAT JALAN SALES ORDER BOND</td>
					<td><?php if (isset($data)) { echo $data->suratjalan_sales_order_bond; } ?></td>
				</tr>
				
				<tr>
					<td style="text-align:left">SURAT JALAN SHIP BOND</td>
					<td><?php if (isset($data)) { echo $data->suratjalan_ship_bond; } ?></td>
				</tr>
