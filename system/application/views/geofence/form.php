...
<script>
	...
	function save(str)
	{
		jQuery.post("<?=base_url()?>geofence/save/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>", {json: str},
			function(r)
			{
				if (r.error)
				{
	...
	function removegeofence()
	{
		...
		jQuery.post("<?=base_url()?>geofence/remove/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>", {},
			function(r)
			{
				...
				location = '<?=base_url()?>geofence/manage/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>/<?php echo uniqid();?>';
			}
			, "json"
		);
	...
	{
		showdialog();
		jQuery.post('<?php echo base_url(); ?>geofence/label', {deviceid: '<?php echo $vehicle->vehicle_device; ?>'},
			function(r)
			{
	...
	{
			showdialog();
			jQuery.post('<?php echo base_url(); ?>geofence/copyto', {vid: <?php echo $vehicle->vehicle_id ?>},
				function(r)
				{
					if (r.error)
					{
	...
	function gotovehicle()
	{
		...
		function othervehicle(elmt)
		{
			...
			location = '<?=base_url()?>geofence/manage/'+v;
		}
	...
	var map, vectors, kml_tracker5 = null;
        ...
        <h1><?=$this->lang->line("lmangeofence"); ?></h1>
		...
		<input class="button" type="button" name="btncancel" id="btncancel" value=" <?php echo $this->lang->line("lcenter_to_geofence"); ?> " onclick="location='<?=base_url()?>geofence/manage/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>/<?php echo uniqid();?>';" />
        </fieldset>
        </td>
        ...
        <legend>Control</legend>
            ...
            <input class="button" type="button" name="btncancel" id="btncancel" value=" <?php echo $this->lang->line("lreset"); ?> " onclick="location='<?=base_url()?>geofence/manage/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>/<?php echo uniqid();?>';" />
        </fieldset>
        </td>
        </tr>
        </table>
