...
<?php 
	if (isset($data))
	{	
		if (isset($data1->dosj_delivery_status) && ($data1->dosj_delivery_status == 1))
		{
?>
	( Status Complete )
<?php
		...
		<table width="100%" cellpadding="3" class="table sortable no-margin" style="margin: 3px;">
			...
			<tbody>
					...
					?>
							<tr>
							<td><?php echo $i+1;?></td>
							<td style="text-align:center"><?php echo $data[$i]->do_delivered_date;?></td>
							<td><?php echo $data[$i]->do_delivered_vehicle;?></td>
				...
				?>
					...
					<td style="text-align:right"><?php echo number_format($tc);?></td>
				<?php
					}
					?>
				</tr>
