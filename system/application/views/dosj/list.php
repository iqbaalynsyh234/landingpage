<script>
	...
	{		
		...
		jQuery.post("<?=base_url()?>transporter/dosj/search/"+p, jQuery("#frmsearch").serialize(), 
			function(r)
			{
	...
	{
		showdialog();
		jQuery.post('<?php echo base_url(); ?>/transporter/dosj/dosj_history/', {id: v},
		function(r)
		{
	...
	{
		showdialog();
		jQuery.post('<?php echo base_url(); ?>/transporter/dosj/dosj_edit/', {id: v},
		function(r)
		{
	...
	{
		showdialog();
		jQuery.post('<?php echo base_url(); ?>/transporter/dosj/dosj_delete/', {id: v},
		function(r)
		{
		...
		jQuery.post("<?=base_url();?>export_dosj/dosj", jQuery("#frmsearch").serialize(),
			function(r)
			{
				jQuery("#loader2").hide();
				if(r.success == true){
...
<div style="position: absolute; margin: 0; padding: 0; z-index: 1000; width: 100%;"> 
	...
	<div id="main" style="margin: 20px;">
		<div class="block-border">
			...
			<br />
			<a href="<?=base_url();?>transporter/dosj/add"><font color="#0000ff">[ Add ]</font></a>	
			<a href="<?=base_url();?>transporter/dosj/mn_manage_do"><font color="#0000ff">[ Manage SO ]</font></a>
			<!--<a href="<?=base_url();?>transporter/dosj/mn_upload_dosj"><font color="#0000ff">[ Import From Excel ]</font></a>-->
			<!--<a href="<?=base_url();?>transporter/dosj/mn_download_dosj_template"><font color="#0000ff">[ Download Sample/Template ]</font></a>-->
		</div>
