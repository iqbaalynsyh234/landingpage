<script>
	...
	{	
		...
		jQuery.post("<?=base_url()?>transporter/dosj/search_hist_driver/"+p, jQuery("#frmsearch").serialize(), 
			function(r)
			{
	...
	function excel_onsubmit(){
		...
		jQuery.post("<?=base_url();?>export_dosj/driver_history", jQuery("#frmsearch").serialize(),
			function(r)
			{
				jQuery("#loader2").hide();
				if(r.success == true){
