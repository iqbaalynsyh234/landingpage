<script>
	...
	{
		jQuery("#loader").show();
		jQuery.post("<?=base_url()?>transporter/dosj/saveedit_cost", jQuery("#frmcost").serialize(),
			function(r)
			{
				jQuery("#loader").hide();
				if (r.error)
		...
		<table width="100%" cellpadding="3" class="table sortable no-margin" style="margin: 3px;">
				...
				<tr>
					...
					<td>
						...
						<input type="button" name="btn_cancel" id="btn_cancel" value="Cancel" onclick="location='<?=base_url()?>transporter/dosj/cost';" />
