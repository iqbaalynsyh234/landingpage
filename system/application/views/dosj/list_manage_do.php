<script>
	...
	{	
		...
		jQuery.post("<?=base_url()?>transporter/dosj/search_manage_do/"+p, jQuery("#frmsearch").serialize(), 
			function(r)
			{
	...
	{
		showdialog();
		jQuery.post('<?php echo base_url(); ?>/transporter/dosj/dosj_hist_edit/', {id: v},
		function(r)
		{
	...
	{
		showdialog();
		jQuery.post('<?php echo base_url(); ?>/transporter/dosj/dosj_hist_delete/', {id: v},
		function(r)
		{
        ...
        {
            jQuery("#loader2").show();	
            jQuery.post("<?=base_url();?>export_dosj/dosj_history", jQuery("#frmsearch").serialize(),
            function(r)
            {
                jQuery("#loader2").hide();
                if(r.success == true)
