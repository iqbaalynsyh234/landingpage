<script>
	...
	{		
		...
		jQuery.post("<?=base_url()?>agent/search/"+n, jQuery("#frmsearch").serialize(), 
			function(r)
			{
...
<?=$navigation;?>
	<div id="main" style="margin: 20px;">
		...
		<a href="<?=base_url();?>agent/add"><font color="#0000ff">[ Add ]</font></a>	
