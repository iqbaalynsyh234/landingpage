...
<script>
	...
	function frmdosj_onsubmit()
	{
		...
		jQuery.post("<?=base_url()?>transporter/dosj_all/save", jQuery("#frmdosj").serialize(),
			function(r)
			{
				jQuery("#loader").hide();
				if (r.error)
			...
			<table width="100%" cellpadding="3" class="tablelist">
    			...
    			<tr style="border: 0px;">
						<td style="border: 0px;" colspan="2">
								...
								<input type="button" name="btncancel" id="btncancel" value=" Cancel " onclick="location='<?=base_url()?>transporter/dosj_all';" />
