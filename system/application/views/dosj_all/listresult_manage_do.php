		<table width="100%" cellpadding="3" class="table sortable no-margin" style="margin: 3px;">
			<thead>
				<tr>
					...
					<th rowspan="2" style="text-align:center;">Delivered Date</th>
			...
			?>
				<tr <?=($i%2) ? "class='odd'" : "";?>>
					...
					<td style="text-align:center;"><?=$data[$i]->do_delivered_do_type;?><br />
						<small><?php if($data[$i]->do_delivered_status == 1){ echo "Completed";}?></small>
					</td>
					...
					<td style="text-align:center;">
						<?php if(isset($data[$i]->do_delivered_date)){
