<script>
	...
	{		
		...
		jQuery.post("<?=base_url()?>transporter/dosj_all/search_cost/"+p, jQuery("#frmsearch").serialize(), 
			function(r)
			{
	...
	{
		showdialog();
		jQuery.post('<?php echo base_url(); ?>/transporter/dosj_all/cost_edit/', {id: v},
		function(r)
		{
	...
	function cost_delete_data(v)
	{
		if (confirm("Are you sure delete this data.?")) {
				jQuery.post('<?=base_url()?>transporter/dosj_all/cost_delete/', {id: v}, 
				function(r){
					if (r.error) {
						alert(r.message);
						return;
...
<div style="position: absolute; margin: 0; padding: 0; z-index: 1000; width: 100%;"> 
	...
	<div id="main" style="margin: 20px;">
		<div class="block-border">
			...
			<br />
			<a href="<?=base_url();?>transporter/dosj_all/cost_add"><font color="#0000ff">[ Add ]</font></a>	
		</div>
