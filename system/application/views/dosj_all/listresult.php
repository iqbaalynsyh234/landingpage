		<table width="100%" cellpadding="3" class="table sortable no-margin" style="margin: 3px;">
			...
			?>
				<tr <?=($i%2) ? "class='odd'" : "";?>>
					...
					<td style="text-align:center;"><?=$data[$i]->dosj_type;?><br />
						<small><?php if($data[$i]->dosj_delivery_status == 2){ echo "Completed";}?></small>
					</td>
					...
					<td style="text-align:center;">
						<?php
							echo date("d-m-Y",strtotime($data[$i]->dosj_ship_date));
						?>
					</td>
					<td>
			...
			<tfoot>
					<tr>
						<td colspan="15"><?php if (isset($paging)) { echo $paging; } ?></td>
					</tr>
			</tfoot>
		</table>
