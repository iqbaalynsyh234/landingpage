...
<div style="position: absolute; margin: 0; padding: 0; z-index: 1000; width: 100%; height: 100%;">
	...
	<!--<center>
		...
		<h2>All List Vehicles Bangun Trans( <?=count($data);?> )</h2>
	</center>-->
	<table width="100%" class="tablelist">
		<tr>
			<td width="30%" style="position:left;">
				...
				<form class="block-content form" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
						...
						<div id="divsearch">
							...
							<table width="100%" cellpadding="1" class="tablelist" style="font-size:11px;">
								<tr >
									...
									<td id="tdsearch">
										...
										<br /><br />
										<strong>List Vehicle ( <?=count($data);?> ) :</strong>
										<br />
										<div id="listvehicle">
							...
							<!--menu follow me-->
								...
								<tr>
									<td>
									<label><a href="javascript:s_map(true)">Show Map</a> | <a href="javascript:s_map(false)">Show Table</a> | <a href="javascript:s_all()">Show All ( Map & Table )</a></label>	
			...
			<td width="70%" style="text-align:top;">
				<div id="result"></div>
			</td>
