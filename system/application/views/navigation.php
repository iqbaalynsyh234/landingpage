...
<script>
  ...
  function user(agent) {
    showdialog();
    jQuery.post('<?=base_url()?>member/showvehicle4agent', {
        agent: agent
      },
      function(r) {
        showdialog(r.html, r.title);
  ...
  function vehicle(userid) {
    showdialog();
    jQuery.post('<?=base_url()?>member/showvehicle4user', {
        userid: userid
      },
      function(r) {
        showdialog(r.html, r.title);
        ...
        <?php if ($this->sess->user_group == 0) { ?>
          ...
          <li id="write_active" class="write current" style="display: none;">
            ...
            <ul class="subnav">
              ...
              <li><a href="<?=base_url();?>historynew">New History</a></li>
                    ...
                    <?php if ($this->sess->user_type != 2 && $this->sess->user_agent != "1") { ?>
                      ...
                      <?php } ?>
                        ...
                        <?php } ?>
                          ...
                          <!--<li>
                            <a href="<?=base_url();?>report/mn_history_trip_mileage">
                              <?="History Trip Mileage";?>
                            </a>
                          </li>-->
                          <li>
                            <a href="<?=base_url();?>report/mn_playback">
                              <?="Playback";?>
                            </a>
                          </li>
                          <li>
                            <a href="<?=base_url();?>report/mn_inout_geofence">
                              <?="In Out Geofence Duration";?>
                            </a>
                          </li>
                          <li>
                            <a href="<?=base_url();?>report/mn_door_status">
                              <?="Door Report";?>
                            </a>
                          </li>
						  <li>
                            <a href="<?=base_url();?>report/mn_pto_status">
                              <?="PTO Report";?>
                            </a>
                          </li>
                          <li>
                            <a href="<?=base_url();?>maxreport/mn_driver_hist">
                              <?="Driver History";?>
                            </a>
                          </li>
						  <?php if ($this->sess->user_id == "3991") { ?>
							<li>
								<a href="<?=base_url();?>transporter/driver/report_rfid">
								<?="Driver RF ID History";?>
								</a>
							</li>
						  <?php } ?>

                          <li>
                            <a href="<?=base_url();?>transporter/ritase/menu_ritase_report">
                              <?="Ritase Report";?>
                            </a>
                          </li>
                          <?php if($this->sess->user_id == 1540 || $this->sess->user_id == 1539) { ?>
                            <li>
                              <a href="<?=base_url();?>bgn_report">
                                <?="History Parking Report";?>
                              </a>
                            </li>
                            <?php } ?>
                              ...
                              <?php if($this->sess->user_id == 3721) { ?>
                                <li>
                                  <a href="<?=base_url();?>kasai/mn_daily_report">
                                    <?="Daily Report";?>
                                  </a>
                                </li>
                                <?php } ?>
                                  <?php if (in_array(strtoupper($this->sess->user_id), $this->config->item("user_view_customreport"))) { ?>
                                    <li>
                                      <a href="<?=base_url();?>operational_report">
                                        <?="Operational Report";?>
                                      </a>
                                    </li>
                                    <li>
                                      <a href="<?=base_url();?>operational_report/summary">
                                    ...
                                    <li>
                                      <a href="<?=base_url();?>operational_report/pto">
                                        <?="Operational Report (PTO)";?>
                                      </a>
                                    </li>
          ...
          <li class="users current" id="users_active" style="display: none;">
            ...
            <ul class="subnav">
              ...
              <li>
                <a href="<?=base_url();?>transporter/branchoffice">
                  <?php echo "Branch Office" ?>
                </a>
              </li>
              <?php if (in_array(strtoupper($this->sess->user_id), $this->config->item("user_view_pto"))) {?>
                <li><a href="<?=base_url();?>projectschedule">Project Schedule</a></li>
              <?php } ?>
              ...
              <li>
                <a href="<?php echo base_url();?>transporter/driver">
                  <?php echo "Driver"; ?>
                </a>
              </li>
              <li>
                <a href="<?=base_url();?>transporter/customer">
                  <?php echo "Customer" ?>
                </a>
              </li>
              <!-- app dosj-->
              <?php if (in_array(strtoupper($this->sess->user_company), $this->config->item("company_view_dosj"))) { ?>
                ...
                <?php } ?>
                  <li>
                    <a href="<?=base_url();?>transporter/ritase">
                      <?php echo "Ritase" ?>
                    </a>
                  </li>
                  <li>
                                      ...
                                      <?php if (($this->config->item("contact_joomla") == 1) && ($this->sess->user_type != 2)) { ?>
                                        ...
                                        <?php } ?>
                                          ...
                                          <?php if ($this->sess->user_trans_tupper == 1) { ?>
                                            <li>
                                              <a href="<?=base_url();?>transporter/tupperware/booking_id">
                                                <?php echo "Tupperware" ?>
                                              </a>
                                            </li>
          </li>
          <?php } ?>
            ...
            <li class="stats" id="config_inactive">
              <a href="javascript:mnconfiguration('inactive')" title="Configuration">
                <?=$this->lang->line("lconfiguration"); ?>
              </a>
            </li>
            <li class="stats current" id="config_active" style="display: none;">
              ...
              <ul>
                <?php if ($this->sess->user_type != 2) { ?>
                    ...
                    <?php if ($this->sess->user_type != 2) { ?>
                      ...
                      <?php } ?>
						...
						<?php if($this->sess->user_id == "4043"){?>
							<li><a href="<?=base_url()?>geofencelist">Geofence(live) List</a></li>
						<?php } ?>
						<li style="border-bottom: #cccccc solid 1px; height: 5px;">&nbsp;</li>
                  ...
                  <?php
                  if ($this->sess->user_id == 4174) {?>
                    <li><a href="<?php echo base_url(); ?>integration">INTEGRASI</a></li>
                  <?php } ?>

                  <?php
                  if ($this->sess->user_id == 1750) {?>
                    <li><a href="<?php echo base_url(); ?>abcargointegration">INTEGRASI</a></li>
                  <?php } ?>
              </ul>
            </li>
            <?php } ?>
              ...
              <?php if ($this->sess->user_company == 23 && $this->sess->user_group <> 0) { ?>
				...
				-->
                  ...
                  <?php if ($this->sess->user_group == 0) { ?>
                    <li class="backup" id="download_inactive">
                      <a href="javascript:mndownload('inactive')" title="Download">
                        <?=$this->lang->line("ldownload"); ?>
                      </a>
                    </li>
    ...
    <div class="container_12">
      ...
      <ul id="status-infos">
        ...
        <!--
			...
			-->
        <!-- end Speed alert-->
		<li><a href="<?=base_url();?>maps" class="button blue" title="Maps New"><span class="smaller">Maps New (beta)</span></a></li>
      ...
      <!--
        <ul id="breadcrumb">
			<li>Live Support</li>
				...
				<a href="ymsgr:sendIM?cici_lacakmobil" class="button" title="Cici Lacakmobil">
				<img border="0" src="http://opi.yahoo.com/online?u=cici_lacakmobil&amp;m=g&amp;t=1"/>
				</a>
				<a href="ymsgr:sendIM?wirdi_lacakmobil" class="button" title="Wirdi Lacakmobil">
				<img border="0" src="http://opi.yahoo.com/online?u=wirdi_lacakmobil&amp;m=g&amp;t=1"/>
				</a>
				<a href="ymsgr:sendIM?ichsan_lacakmobil" class="button" title="Ichsan Lacakmobil">
				<img border="0" src="http://opi.yahoo.com/online?u=ichsan_lacakmobil&amp;m=g&amp;t=1"/>
				</a>
				<a href="ymsgr:sendIM?alfa_funky" class="button" title="Alfa Lacakmobil">
				<img border="0" src="http://opi.yahoo.com/online?u=alfa_funky&amp;m=g&amp;t=1"/>
				</a>
		</ul>
		-->
		<ul id="breadcrumb">
  ...
  <div id="dvalert_geofence" style="top:0px; right:0; position: absolute; display: none;">
    <div class="block-border">
      <table style="font-size:12px;color:white;">
        ...
        <tr>
          <td><span id="message_geo_alert"></span></td>
        </tr>
      </table>
    </div>
  </div>
