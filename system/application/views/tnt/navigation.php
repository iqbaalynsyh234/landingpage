<!-- BEGIN OF MAIN MENU --> 
<link media="screen" href="<?=base_url()?>assets/css/commonv1_tnt.css" type="text/css" rel="stylesheet">
<style>
		...
		<?php if (isset($globaljs)) echo $globaljs; ?>	
			...
			<?php } ?>
			   ...
			   <?php } ?>	
				...
				<?php if (base_url() == "http://www.lacak-mobil.com/" || base_url() == "http://lacak-mobil.com/") { 
