			...
			<?php if ($this->sess->user_type != 4)  { ?>
				...
				<li id="write_active" class="write current" style="display: none;">
			        ...
			        <ul class="subnav"> 
						...
						<li><a href="<?=base_url();?>ssi_report/mn_dailydataoperasional"><?="Daily Operational Report";?></a></li>
						<li><a href="<?=base_url();?>ssi_report/mn_ritase_report"><?="Ritase Report";?></a></li>
						<?php if ($this->sess->user_group == 0 && $this->sess->user_type <> 5) { ?>
							<li><a href="<?=base_url();?>ssi_report/mn_dataoperasional"><?="Operational Report";?></a></li>
						<?php } ?>
						<?php if ($this->sess->user_group == 0 && $this->sess->user_id == 1933) { ?> <!-- SSI user id -->
			            <?php if ($totalGTP) { ?>
				...
				<?php echo "Manage"; ?></a>
					...
					<?php } ?>
						...
						<li><a href="<?php echo base_url();?>ssi_team/"><?php echo "Team"; ?></a></li>
						<li><a href="<?php echo base_url();?>ssi_info_alert/"><?php echo "Info Alert"; ?></a></li>
					<?php if ($this->sess->user_group == 0 && $this->sess->user_id == 1933) { ?>
