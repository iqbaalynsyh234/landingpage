...
?>		
	...
	<tr>
		...
		<td>:</td>
		<td><?=number_format($data->gps_speed*1.852, 0, "", ",")?> km/jam
		
		<?php 
		if($vehicle->vehicle_maxspeed > 0){
			$speednow = number_format($data->gps_speed*1.852, 0, "", ",");
			if ($speednow >= $vehicle->vehicle_maxspeed) 
				{ ?>
					<img src='<?php echo base_url();?>assets/images/alert_kecepatan.png' border='0' width='15' height='15' title="Speed Alert" />
			<?php }
