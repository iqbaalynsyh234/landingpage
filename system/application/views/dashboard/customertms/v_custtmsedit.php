        ...
        <div class="panel" id="panel_form">
          ...
          <div class="panel-body" id="bar-parent10">
            ...
            <form class="form-horizontal" name="frmjoborder" id="frmjoborder" onsubmit="frmjoborder_onsubmit();">
              <input type="hidden" name="custid" id="custid" value="<?php echo $custdata[0]['customer_id']; ?>">
              <input type="checkbox" name="geofencechecking" id="geofencechecking" value="1" onchange="checkgeofence();" checked> Geofence Checking
                  ...
                  <tr>
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="joborder_customername" name="joborder_customername" value="<?php echo $custdata[0]['customer_name']; ?>">
                          </div>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="joborder_customercode" name="joborder_customercode" value="<?php echo $custdata[0]['customer_code']; ?>">
                          </div>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="joborder_customercodearea" name="joborder_customercodearea" value="<?php echo $custdata[0]['customer_code_area']; ?>">
                          </div>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="joborder_geofencename" name="joborder_geofencename" value="<?php echo $custdata[0]['customer_geofence_name']; ?>" readonly>
                          </div>
                      </div>
                    </td>
                  </tr>
                    ...
                    <tr>
                      <td>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo $latlng[0]; ?>" readonly>
                            </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="longitude" name="longitude" value="<?php echo $latlng[1]; ?>"  readonly>
                            </div>
                        </div>
                      </td>
                    </tr>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <textarea type="text" class="form-control" id="addressfix" name="addressfix" rows="8" cols="80" readonly>
                                <?php echo $custdata[0]['customer_address']; ?>
                              </textarea>
                            </div>
                        </div>
                      </td>
...
<script type="text/javascript">
  ...
  function frmjoborder_onsubmit(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>customer/updatecusttms", jQuery("#frmjoborder").serialize(), function(response){
      ...
      if (response.code == 400) {
        ...
        $("#loadernya").hide();
        if (confirm("Joborder succesfully updated")) {
          window.location = '<?php echo base_url() ?>customer';
        }
      }
    }, "json");
