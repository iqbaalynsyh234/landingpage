              ...
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tbody>
                  <?php for($i=0;$i<count($subcompany);$i++) { ?>
                      ...
                      <td>
                        <?php
                        for ($j=0; $j < sizeof($subbranchorigin); $j++) {
                          if ($subcompany[$i]->subcompany_id == $subbranchorigin[$j]['origin_subbranch_subcompanyid']) {?>
                            <?php
                              echo $subbranchorigin[$j]['origin_subbranch_address'].'<br>';
                              echo $subbranchorigin[$j]['origin_subbranch_lat'].','.$subbranchorigin[$j]['origin_subbranch_lng']; ?>
                        <?php } } ?>
                      </td>
                      <td>
