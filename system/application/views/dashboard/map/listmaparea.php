...
<style>
	...
	<form id="frmvehicle">
		...
		<tr>
		<td>
			<div id="map" width="80%" style="position:absolute;"></div>
			<span id='tblrealtime' style='display:none;'>
				<table id="boxtable" width="77%" cellspacing="2" style='display:none;'> 
					<thead>
						<tr class="toprow">
							<th width="2%"><?=$this->lang->line("lno"); ?></th>
							<th colspan="2"><?=$this->lang->line("lvehicle"); ?></th>
							<th><?php echo "Driver"; ?></th>
							<th width="10%" align="center"><?=$this->lang->line("ldatetime"); ?></th>
							<th><?=$this->lang->line("lposition"); ?></th>
							<th width="7%"><?php echo "Device"; ?></th>
					...
					<tbody>
							...
							<tr <?=($i%2) ? "class='odd'" : "";?> id="tr<?=$data[$i]->vehicle_id;?>">
								<td><?=$i+1?></td>
								<td width="1px;"><?=$data[$i]->vehicle_no;?> <br /><font color='#0000FF'><?=$data[$i]->vehicle_name;?></font></td>
								<td width="1px">
								...
								<td>
									<span id="map<?=$data[$i]->vehicle_id;?>" style="display: none;">
										<a href="<?=base_url(); ?>maps/realtime/<?=$data[$i]->vehicle_device_name;?>/<?=$data[$i]->vehicle_device_host;?>"><img src="<?=base_url();?>assets/images/realtime.png" width="20" border="0" alt="<?=$this->lang->line("lshow_map"); ?>" title="<?=$this->lang->line("lshow_map"); ?>"></a>
									</span>
								</td>
							</tr>
