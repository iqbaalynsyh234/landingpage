...
function page(p)
	{
		...
		jQuery("#loader2").show();
		jQuery.post("<?=base_url();?>dailyactivityreport/searchactivity", jQuery("#frmsearch").serialize(),
			function(r)
			{
      ...
      <div class="page-content-wrapper">
          <div class="page-content">
              <div class="row">
                  ...
                  <header class="panel-heading panel-heading-blue">DAILY ACTIVITY REPORT</header>
                  <div class="panel-body" id="bar-parent10">
                    ...
                    <div class="form-group row">
											<label class="col-lg-3 col-md-4 control-label">Stop Duration (Minute)</label>
                      <div class="col-lg-4 col-md-3">
                        <input type="text" class="form-control" name="stopduration" id="stopduration" value="15">
                      </div>
                    </div>
