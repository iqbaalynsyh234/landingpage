...
<?php } ?>
			<header class="panel-heading panel-heading-blue">REPORT JBI</header>
				<div class="panel-body" id="bar-parent10">
                    ...
                    <th style="text-align:center;" width="20%">Detail Location Start</th>
                    <th style="text-align:center;" width="10%">Latitude Start</th>
                    <th style="text-align:center;" width="10%">Longitude Start</th>
                    <th style="text-align:center;" width="10%">Geofence End</th>
                    <th style="text-align:center;" width="20%">Detail Location End</th>
                    <th style="text-align:center;" width="10%">Latitude End</th>
                    <th style="text-align:center;" width="10%">Longitude End</th>
		...
		if(isset($data) && (count($data) > 0)){
          ...
          <td>
            <strong>
              <font color="red">
                <?php
                  $coordnya = explode(" ",  $data[$i]->trip_mileage_coordinate_start);
                  echo $coordnya[0];
                ?>
              </font>
            </strong>
          ...
          <td>
            <strong>
              <font color="red">
                <?php
                  $coordnyaend = explode(" ", $data[$i]->trip_mileage_coordinate_end);
                    echo $coordnyaend[0];
                ?>
              </font>
            </strong>
