...
function page(p)
	{
		...
		jQuery("#loader2").show();
		jQuery.post("<?=base_url();?>operationalreport/search_door", jQuery("#frmsearch").serialize(),
			function(r)
			{
				if (r.error) {
					alert(r.message);
...
function company_onchange(){
		...
		if(data_company == 0){
			...
			var site = "<?=base_url()?>operationalreport/get_vehicle_door_by_company/" + data_company;
		    jQuery.ajax({
		        url: site,
                    ...
                    <div class="row">
						<div class="col-md-12 col-sm-12">
                            <div class="panel" id="panel_form">
                                <header class="panel-heading panel-heading-blue">OPERATIONAL REPORT (DOOR)</header>
                                <div class="panel-body" id="bar-parent10">
                                    <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-md-4 control-label">Door
                                            </label>
											...
											<div class="col-lg-3 col-md-3">
												<td style="border: 0px;"><input type="checkbox" name="checkdetail" id="checkdetail" value="1" checked /> View Detail <br /><small>OPEN ON < 1 menit</small></td>
											</div>
