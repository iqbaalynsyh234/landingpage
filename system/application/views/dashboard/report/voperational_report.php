...
function page(p)
	{
		...
		jQuery("#loader2").show();
		jQuery.post("<?=base_url();?>dashboard/dataoperational/", jQuery("#frmsearch").serialize(),
			function(r)
			{
				if (r.error) {
					alert(r.message);
...
function option_type_km(v)
	...
	// FUNGSI GOTO HISTORY MAP
		function historymap(){
			jQuery("#loader2").show();
			jQuery.post("<?=base_url();?>dashboard/dataoperational_map", jQuery("#frmsearch").serialize(),
				function(r)
				{
					jQuery("#loader2").hide();
                            ...
                            <div class="panel" id="panel_form">
                                ...
                                <div class="panel-body" id="bar-parent10">
                                    <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-md-4 control-label">Engine
                                            </label>
											...
											<label class="col-lg-3 col-md-4 control-label">Duration (minute)
                                            </label>
                                            <div class="col-lg-3 col-md-4">
												<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-01">
													<input name="type_duration" id="option-01" type="radio" value="" onClick="option_type_duration('duration_no')" class="mdl-radio__button" checked >
													<span class="mdl-radio__label">No</span>
												</label>
												<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-02">
													<input name="type_duration" id="option-02" type="radio" value="1"  onClick="option_type_duration('duration_yes')" class="mdl-radio__button">
													<span class="mdl-radio__label">Yes</span>
												</label>
												
												<div id="duration_view" style="display:none"> 
													From: <input class="form-control" type="text" name="s_minute" id="s_minute" value="" size="3" placeholder="0~9" maxlength="4"/> 
													To: <input class="form-control" type="text" name="e_minute" id="e_minute" value="" size="3" placeholder="0~9" maxlength="4"/> 
												</div>
											</div>
										...
										<div class="form-group row">
											...
											<label class="col-lg-3 col-md-4 control-label">Filter KM
                                            </label>
                                            <div class="col-lg-2 col-md-4">
												<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-11">
													<input name="type_km" id="option-11" type="radio" value=""  onClick="option_type_km('km_no')" class="mdl-radio__button" checked >
													<span class="mdl-radio__label">No</span>
												</label>
												<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-21">
													<input name="type_km" id="option-21" type="radio" value="1"  onClick="option_type_km('km_yes')" class="mdl-radio__button">
													<span class="mdl-radio__label">Yes</span>
												</label>
												...
												<div id="km_view" style="display:none"> 
													From: <input class="form-control" type="text" name="km_start" id="km_start" value="" size="3" placeholder="0~9 (KM)" maxlength="3"/>
													To: <input class="form-control" type="text" name="km_end" id="km_end" value="" size="3" placeholder="0~9 (KM)" maxlength="3" />
												</div>
											</div>
