...
<script>
	...
	function frmadd_onsubmit(frm)
	{
		...
		//location = '<?=base_url()?>geofencedata/manage/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>/label/<?php echo uniqid();?>';
	...
	function save(str)
	{
		jQuery.post("<?=base_url()?>geofencedata/save/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>", {json: str},
			function(r)
			{
				if (r.error)
				{
	...
	function removegeofence()
	{
		...
		jQuery.post("<?=base_url()?>geofencedata/remove/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>", {},
			function(r)
			{
				if (r.error)
				{
				...
				location = '<?=base_url()?>geofencedata/manage/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>/<?php echo uniqid();?>';
			}
			, "json"
		);
	...
	{
		showdialog();
		jQuery.post('<?php echo base_url(); ?>geofencedata/label', {deviceid: '<?php echo $vehicle->vehicle_device; ?>'},
			function(r)
			{
	...
	{
		jQuery.post("<?php echo base_url(); ?>geofencedata/get/"+gid, {},
			function(r)
			{
	...
	function removegeofence(gid)
	{
		...
		jQuery.post("<?php echo base_url(); ?>geofencedata/removebyid/"+gid, {},
			function(r)
			{
				if (r.error)
				{
	...
	function removegeofence_byvehicle(gid)
	{
		...
		jQuery.post("<?php echo base_url(); ?>geofencedata/removebyvehicle/"+gid, {},
			function(r)
			{
				if (r.error)
				{
	...
	function savegeo()
	{
		jQuery.post("<?php echo base_url(); ?>geofencedata/savelabel/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>", jQuery("#frmadd1").serialize(),
			function(r)
			{
	...
	{
			showdialog();
			jQuery.post('<?php echo base_url(); ?>geofencedata/copyto', {vid: <?php echo $vehicle->vehicle_id ?>},
				function(r)
				{
					if (r.error)
					{
	...
	function gotovehicle()
	{
		...
		function othervehicle(elmt)
		{
			...
			location = '<?=base_url()?>geofencedata/manage/'+v;
		}
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <legend>Control</legend>
                          ...
                          <a href="<?=base_url();?>geofencedatalist" class="btn btn-flat" type="button" ><?php echo $this->lang->line("lgeofence_list"); ?> </a>
