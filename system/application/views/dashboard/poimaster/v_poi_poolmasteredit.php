    ...
    <div class="row">
      <div class="col-md-12" id="formaddpoolmaster">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading-blue">  Edit Pool Master</header>
          <div class="panel-body" id="bar-parent10">
            <form class="form-horizontal" action="<?php echo base_url()?>poolmaster/updatepoolmaster" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" id="id" value="<?php echo $data[0]['poi_id']?>">
              <div class="form-group row">
                  <label for="horizontalFormEmail" class="col-sm-2 control-label">Pool Name</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="poolname" name="poolname" placeholder="Pool Name" value="<?php echo $data[0]['poi_name']?>">
                  </div>
              </div>
                  ...
                  <tr>
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo $data[0]['poi_lat']?>" readonly>
                          </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="longitude" name="longitude" value="<?php echo $data[0]['poi_lng']?>" readonly>
                          </div>
                      </div>
                    </td>
                  </tr>
...
function btncancel(){
  window.location = '<?php echo base_url()?>poolmaster';
}
