    ...
    <div class="row">
      <div class="col-md-12" id="formaddpoolmaster">
        <div class="card-box">
          ...
          <div class="card-body">
            <form class="form-horizontal" action="<?php echo base_url()?>destinationmaster/updatedestmaster" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" id="id" value="<?php echo $data[0]['dest_id']?>">
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control select2" name="dest_vehicle" id="dest_vehicle" style="width: 30%;">
                      <option value="<?php echo $data[0]['dest_vehicle_device'].'.'.$data[0]['dest_vehicle_no']?>"><?php echo $data[0]['dest_vehicle_no']?></option>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control select2" name="dest_driver" id="dest_driver" style="width: 30%;">
                      <option value="<?php echo $data[0]['dest_driver_id'].'.'.$data[0]['dest_driver_name']?>"><?php echo $data[0]['dest_driver_name']?></option>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="destname" name="destname" placeholder="Destination Name" value="<?php echo $data[0]['dest_name']?>">
                  </div>
              </div>
              ...
              <div class="form-group row">
                 <label for="horizontalFormEmail" class="col-sm-2 control-label">Destination Date</label>
                  <div class="input-group date form_date col-md-4" data-date="" data-date-format="dd-mm-yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                      <input class="form-control" size="5" type="text" readonly name="dest_endshowing_date" id="dest_endshowing_date" value="<?php echo $data[0]['dest_endshowing_date']?>">
                  ...
                  <tr>
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo $data[0]['dest_lat']?>" readonly>
                          </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="longitude" name="longitude" value="<?php echo $data[0]['dest_lng']?>" readonly>
                          </div>
                      </div>
                    </td>
                  </tr>
...
function btncancel(){
  window.location = '<?php echo base_url()?>destinationmaster';
}
