  ...
  <div class="page-content">
    <div class="row">
      <div class="col-md-12" id="showmaps">
        ...
        <div id="map_canvas" style="height: 580px; width:100%; margin-left: 0%; margin-top: 0%; position:relative; "></div>
      </div>
    </div>
...
<script>
  ...
  var markerpool = [];
  var JSONpoolmaster, objpoolmaster;
  ...
  function initialize() {
    ...
    obj = datacode;
    console.log("obj : ", obj);
    console.log("objpoolmaster : ", objpoolmaster);
    ...
    var iconpool = {
      url: "assets/images/markergif.gif", // url
    ...
    for (var x = 0; x < objpoolmaster.length; x++) {
      // console.log("masuk looping");
      var positionpool = new google.maps.LatLng(objpoolmaster[x].poi_lat, objpoolmaster[x].poi_lng);
      ...
      markerpool = new google.maps.Marker({
        ...
        map: map,
        icon: iconpool,
        title: objpoolmaster[x].poi_name,
        id: objpoolmaster[x].poi_name,
        optimized: false
      });
    ...
    // });
    //
    // infowindowgif.open(map, markerpool);
