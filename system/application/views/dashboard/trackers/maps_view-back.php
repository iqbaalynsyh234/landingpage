        ...
        <div id="main" style="margin: 20px;">
          ...
          <table>
            <tr>
              ...
              <td>:</td>
              <td>
                <select name="selectVehicleForTrack" id="selectVehicleForTrack" onchange="v_forrealtime();">
                  <option value="">-- Select Vehicle --</option>
                  <?php foreach ($vehicle as $rowdatanya) {?>
                    <option value="<?php echo $rowdatanya['auto_vehicle_device']?>">
                      <?php echo $rowdatanya['auto_vehicle_no']." - ".$rowdatanya['auto_vehicle_name']; ?>
                    </option>
                    <?php } ?>
                </select>
            ...
            <tr>
              <td>
                <a href="<?php echo base_url()?>trackers">
            ...
            <div id="result">
              <!--<input type="checkbox" id="autoupdate" onclick="autoupdatechecked()">Auto Update-->
              <br>
              <br>
              <div id="map_canvas" style="height: 510px; width:96%; margin-left: 2%; margin-top: -4%;"></div>
            </div>
