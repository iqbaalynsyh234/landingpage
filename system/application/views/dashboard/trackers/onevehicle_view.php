...
jQuery("#detailinfo").show();
  ...
  function initialize() {
    ...
    JSONString = '<?php echo json_encode($devices); ?>';
    ...
    var intervalkedua = setInterval(getdata, 60000);
  }
...
<div id="map_canvas2" style="height: 510px; width:96%; margin-left: 2%; margin-top: -1%;"></div>
