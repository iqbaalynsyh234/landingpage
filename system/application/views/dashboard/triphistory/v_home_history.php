    ...
    $("#showresulthistory").hide();
        ...
        for (var i = 0; i < r.data.length; i++) {
           html += '<tr>';
                ...
                html += '<td style="font-size: 12px;">'+r.data[i].gps_date_fmt+'</td>';
                html += '<td style="font-size: 12px;">'+r.data[i].gps_time_fmt+'</td>';
                ...
                html += '<td style="font-size: 12px;">'+r.data[i].gpstatus+'</td>';
                html += '<td style="font-size: 12px;">'+r.data[i].gps_speed_fmt+'</td>';
                html += '<td style="font-size: 12px;">'+r.data[i].status1+'</td>';
                html += '<td style="font-size: 12px;">'+r.data[i].odometer+'</td>';
              html += '</tr>';
        }
