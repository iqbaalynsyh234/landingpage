  ...
  <div class="page-content" id="page-content-new">
    ...
    <?php if ($this->session->flashdata('notif')) {?>
      ...
      <?php }?>
        ...
        <div class="row">
          <div class="col-md-12" id="tabletripworkhourreport">
            <div class="card-box">
          ...
          <div class="col-md-12" id="showresultworkhour" style="display: none;">
            <div class="card-box">
              <div class="card card-topline-green">
                <div class="card-head">
                  ...
                  <table class="table" id="stprint">
                    <thead>
                      <tr>
          					   ...
          					   <th width="30%" style="text-align: center;">Long Time &nbsp;&nbsp;</th>
          				    </tr>
                    </thead>
                    <tbody id="dvresult">
                      <!-- <div id="dvresult"></div> -->
    ...
    $("#loadernya").show();
        ...
        for (var i = 0; i < r.data.length; i++) {
           html += '<tr>';
                ...
                html += '<td style="font-size: 12px;">'+r.data[i][1]+'</td>';
                html += '<td style="font-size: 12px;">'+r.data[i][0]+'</td>';
                html += '<td style="font-size: 12px;">'+r.data[i][3]+'</td>';
              html += '</tr>';
        }

        $("#headernya1").html("Workhour Report " + r.title);
        $("#headernya2").html("Workhour Report " + r.title);
				$("#dvresult").html(html);
				$("#reporttitle").html(r.title);
        $("#showresultworkhour").show();
			}
			, "json"
		);
	}
