  ...
  <div class="page-content" id="page-content-new">
    ...
    <?php if ($this->session->flashdata('notif')) {?>
      ...
      <?php }?>
        ...
        <div class="row">
          <div class="col-md-12" id="tabletripparkingtimereport">
            <div class="card-box">
                  ...
                  <form class="block-content form" name="frmsearch" id="frmsearch" method="post" action="<?=base_url(); ?>triphistory/search/<?=$this->uri->segment(2);?>/<?=$this->uri->segment(3);?>/<?=$this->uri->segment(4);?>" onsubmit="javascript: return frmsearch_submit()">
                    ...
                    <table class="table">
                      ...
                      <tr>
                        ...
                        <td>
                          <?=$this->lang->line("lhour"); ?>
                          <input type='text' name="hparkingtime" id="hparkingtime" class='form-control' value="<?php if (isset($_POST['hparkingtime'])) echo $_POST['hparkingtime']; ?>" style="text-align: right;">
                        </td>
      									<td style="border: 0px;" colspan="5">
                          <?=$this->lang->line("lminute"); ?>
    											<input type='text' name="mparkingtime" id="mparkingtime" class='form-control' value="<?php if (isset($_POST['mparkingtime'])) echo $_POST['mparkingtime']; ?>" style="text-align: right;">
                        </td>
                      </tr>
                      <tr id="tglperiod">
                        <td>Date Time</td>
          ...
          <div class="col-md-12" id="showresultparkingtime" style="display: none;">
            <div class="card-box">
              <div class="card card-topline-green">
                <div class="card-head">
    ...
    $("#showresultparkingtime").hide();
        ...
        for (var i = 0; i < r.data.length; i++) {
           html += '<tr>';
                ...
                html += '<td style="font-size: 12px;">'+ 'Geofence : ' + r.data[i].geofence + '\n' +r.data[i].georeverse.display_name+'</td>';
                html += '<td style="font-size: 12px;">'+r.data[i].gps_latitude_real_fmt+ ' ' +r.data[i].gps_longitude_real_fmt+'</td>';
                html += '<td style="font-size: 12px;">'+r.data[i].parkingtime_fmt+'</td>';
              html += '</tr>';
        }

        $("#headernya1").html("Parking Time Report " + r.title);
        $("#headernya2").html("Parking Time Report " + r.title);
        $("#dvresult").html(html);
