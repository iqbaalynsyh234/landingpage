<script>
	...
	function page(p)
	{
		...
		jQuery.post("<?=base_url();?>transporter/ppi_mod_vehicle_maintenance/search_kir_expired/"+p, jQuery("#frmsearch").serialize(),
			function(r)
			{
				jQuery("#loader").hide();
	...
	function kir_edit(id)
		{
			showdialog();
			jQuery.post('<?=base_url()?>transporter/ppi_mod_vehicle_maintenance/mn_kir_edit/' + id, {},
				function(r)
				{
					if (r.error)
					{
...
<?=$navigation;?>
	<div id="main" style="margin: 20px;">
		...
		<h1>KIR Expired List (<span id="total"></span>)</h1>
