<script>
	...
	function page(p)
	{
		...
		jQuery.post("<?=base_url();?>transporter/ppi_mod_vehicle_maintenance/search_stnk_expired/"+p, jQuery("#frmsearch").serialize(),
			function(r)
			{
				jQuery("#loader").hide();
	...
	function stnk_edit(id)
		{
			showdialog();
			jQuery.post('<?=base_url()?>transporter/ppi_mod_vehicle_maintenance/mn_stnk_edit/' + id, {},
				function(r)
				{
					if (r.error)
					{
...
<?=$navigation;?>
	<div id="main" style="margin: 20px;">
		...
		<h1>STNK Expired List (<span id="total"></span>)</h1>
