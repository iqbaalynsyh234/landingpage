...
<?php } ?>		
        ...
        switch (v)
        {
            case "inactive":
				...
				jQuery("#masterdata_active").hide();
                jQuery("#masterdata_inactive").show();
            break;    
            case "active":
        ...
        function mndownload(v)
        {
		 ...
		 function mnmasterdata(v)
        {
            switch(v)
            {
            case "inactive":
                jQuery("#masterdata_active").show();
                jQuery("#masterdata_inactive").hide();
                jQuery("#alert_active").hide();
                jQuery("#alert_inactive").show();
                jQuery("#config_active").hide();
                jQuery("#config_inactive").show();
	...
	-->
		...
		<header>
			<div class="container_12">
				...
				<div class="server-info">&copy; <strong>gpsandalas.com</strong></div>
        ...
        <a name="atop"></a>
			...
			<?php if ($this->sess->user_type != 4)  { ?>
				...
				<?php if ($this->sess->user_id == 2191 || $this->sess->user_id == 2220) { ?> 
				<!--andalas menu -->
				<li class="fleets_data" id="masterdata_inactive"><a href="javascript:mnmasterdata('inactive')" title="Data Job">Manage Job</a>
				</li>
				<li class="fleets_data current" id="masterdata_active" style="display: none;">
					<a href="javascript:mnmasterdata('active')" title="Master Data">Manage Job</a>
					<ul>
						<li><a href="<?=base_url();?>andalas_customer_company">Data Customer Company</a></li>
						<li><a href="<?=base_url();?>andalas_customer">Data Customer</a></li>
						<li><a href="<?=base_url();?>andalas_info_alert">Data Dispatcher</a></li>
						<li><a href="<?=base_url();?>andalas_config">Config</a></li>
						<li><a href="<?=base_url();?>andalas_job_schedule">Job Schedule</a></li>
			        </ul>     	
			    </li> 
				<?php } ?>
...
<!-- END OF MAIN MENU --> 
 <!-- Status bar -->
	<div id="status-bar"><div class="container_12">
        ...
        <ul id="breadcrumb">
			<li>Live Support</li>
				 <a href="ymsgr:sendIM?zad_anwar" class="button">
					<img border="0" src="http://opi.yahoo.com/online?u=zad_anwar&amp;m=g&amp;t=1"/>
				</a>
				<a href="ymsgr:sendIM?cs_andalas02" class="button">
					<img border="0" src="http://opi.yahoo.com/online?u=cs_andalas02&amp;m=g&amp;t=1"/>
				</a>
				<a href="ymsgr:sendIM?norman_akhmad" class="button">
					<img border="0" src="http://opi.yahoo.com/online?u=norman_akhmad&amp;m=g&amp;t=1"/>
				</a>
			</ul>
