        ...
        <a name="atop"></a>
			...
			<?php if ($this->sess->user_type != 4)  { ?>
			    <li class="home">
					...
					<a href="<?=base_url();?>mod_dist_tupperware"><?=$this->lang->line("lhome"); ?></a>
					<?php } else { ?>
				...
				<?php echo "Manage"; ?></a>
			        <ul class="subnav">
			        	...
			        	<?php } ?>
						<li><a href="<?=base_url();?>transporter/tupperware/booking_id"><?php echo "ID Booking" ?></a></li>
						<li><a href="<?=base_url();?>transporter/tupperware/mn_distributor"><?php echo "DB ( Distributor )" ?></a></li>
						<li><a href="<?=base_url();?>transporter/tupperware/mn_type_armada"><?php echo "Type Armada" ?></a></li>   
						<li><a href="<?=base_url();?>transporter/tupperware/mn_barcode"><?php echo "Barcode" ?></a></li>   
						<li><a href="<?=base_url();?>transporter/tupperware/mn_slcars"><?php echo "Transporter(SLCARS)" ?></a></li>
						<li><a href="<?=base_url();?>transporter/tupperware/mn_download_barcode"><?php echo "Download Barcode" ?></a></li>
						<li><a href="<?=base_url();?>transporter/tupperware/mn_dr"><?php echo "DR/SO" ?></a></li>
			        </ul> 
			    </li>
			<!--
