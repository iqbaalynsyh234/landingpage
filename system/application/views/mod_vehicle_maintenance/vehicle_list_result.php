		<table width="100%" cellpadding="3" class="table sortable no-margin" style="margin: 3px;">
			<thead>
				<tr>
					...
					<th style="text-align:center;">Vehicle Receive Date</th>
			...
			?>
				<tr <?=($i%2) ? "class='odd'" : "";?>>
					...
					<td valign="top" style="text-align:center;"><?=$data[$i]->mobil_no_kir;?></td>
					<td valign="top" style="text-align:center;">
						<?php 
							$v = $data[$i]->mobil_registration_date;
							$val = date("d-m-Y",strtotime($data[$i]->mobil_registration_date));
							echo $val;
						?>
					</td>
					<td valign="top" style="text-align:center;">	
