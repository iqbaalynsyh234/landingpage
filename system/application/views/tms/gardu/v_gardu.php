...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
    ...
    <div class="row">
            ...
            <div class="card-body">
              <table class="table" class="display" class="full-width">
                  <thead>
                      <tr>
                          <th>
                            <button type="button" class="btn btn-success btn-xs" onclick="showaddtmsgardu()" title="Add New Substation">
                            <span class="fa fa-plus"></span>
                          </button>No
                          </th>
                  ...
                  <tbody>
                    <?php $no = 1; foreach ($datagardu as $rowdatagardu) {?>
                      <tr>
                        <td class="text-center"><?php echo $no ?></td>
                        <td><?php echo $rowdatagardu['gardu_name'] ?></td>
                        <td>
                          <?php echo $rowdatagardu['gardu_address'] ?> <br>
                          <a href="http://maps.google.com/?q=<?php echo $rowdatagardu['gardu_lat']. "," .$rowdatagardu['gardu_lng'] ;?>" target="_blank">
                            <?php echo $rowdatagardu['gardu_lat']. "," .$rowdatagardu['gardu_lng'] ;?>
                          </a>
                        </td>
                        <td>
                          <a type="button" class="btn btn-primary" href="<?php echo base_url();?>tms/tms_gardu_edit/<?php echo $rowdatagardu['gardu_id'];?>" title="Edit Data">
                            <span class="fa fa-edit"></span>
                          </a>

                          <button type="button" class="btn btn-danger" onclick="btnDelete('<?php echo $rowdatagardu['gardu_id'];?>')" title="Delete Data">
      ...
      <div class="col-md-12" id="formaddgardumaster" style="display: none;">
        <div class="card-box">
          <div class="card-header">
            Add Substation Master
          </div>

          <div class="card-body">
            <form class="form-horizontal" action="<?php echo base_url()?>tms/savesubstationmaster" method="post" enctype="multipart/form-data">
              <div class="form-group row">
                  <label for="horizontalFormEmail" class="col-sm-2 control-label">Substation Name</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="gardu_name" name="gardu_name" placeholder="Substation Name">
                  </div>
              </div>
...
<div id="modalDeleteGardu" style="display: none;">
  <div id="mydivheader"></div>
  <div class="row" >
    <div class="col-md-12">
        <div class="card card-topline-yellow">
            <div class="card-head">
                <header>Delete Substation Master Data</header>
                <div class="tools">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="<?php echo base_url()?>tms/delete" method="post" enctype="multipart/form-data">
...
$("#formaddgardumaster").hide();
$("#notifnya").fadeIn(1000);
$("#notifnya").fadeOut(5000);

function showaddtmsgardu(){
  $("#formaddgardumaster").show();
...
function btnDelete(id){
  $("#iddelete").val(id);
  $("#modalDeleteGardu").show();
}

function closemodallistofvehicle(){
  $("#modalDeleteGardu").hide();
}
