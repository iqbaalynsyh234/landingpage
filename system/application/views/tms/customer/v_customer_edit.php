    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card-box">
          ...
          <div class="card-body">
            <form class="form-horizontal" action="<?php echo base_url()?>tms/updatecustomer" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" id="id" value="<?php echo $data[0]['webtracking_tms_customer_id']?>">
              <div class="form-group row">
                  <label for="horizontalFormEmail" class="col-sm-2 control-label">Customer Name</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" value="<?php echo $data[0]['webtracking_tms_customer_name']?>" placeholder="Customer Name">
                  </div>
              </div>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <input type="number" class="form-control" id="customer_phone" name="customer_phone" value="<?php echo $data[0]['webtracking_tms_customer_phone']?>" placeholder="Customer Name">
                  </div>
              </div>
                  ...
                  <tr>
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo $data[0]['webtracking_tms_customer_lat']?>" readonly>
                          </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" id="longitude" name="longitude" value="<?php echo $data[0]['webtracking_tms_customer_lng']?>" readonly>
                          </div>
                      </div>
                    </td>
                  </tr>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <textarea type="text" class="form-control" id="addressfix" name="addressfix" rows="8" cols="80" readonly>
                                <?php echo $data[0]['webtracking_tms_customer_address']?>
                              </textarea>
                          </div>
                      </div>
                    </td>
...
function btncancel(){
  window.location = '<?php echo base_url()?>tms/customer';
}
