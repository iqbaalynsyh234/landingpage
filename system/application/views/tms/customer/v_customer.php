...
<div class="page-content-wrapper">
  ...
  <div class="page-content">
    ...
    <?php }?>
    <div class="row">
      <div class="col-md-12" id="formtablecustomermaster">
          <div class="card-box">
            ...
            <div class="card-body">
              <table class="table" class="display" class="full-width">
                  <thead>
                      <tr>
                          <th>
                            <button type="button" class="btn btn-success btn-xs" onclick="showaddtmscustomer()" title="Add New Customer">
                            <span class="fa fa-plus"></span>
                          </button>No
                          </th>
                          <th>Customer Name</th>
                  ...
                  <tbody>
                    <?php $no = 1; foreach ($datacustomer as $rowdatacustomer) {?>
                      <tr>
                        <td class="text-center"><?php echo $no ?></td>
                        <td><?php echo $rowdatacustomer['webtracking_tms_customer_name'] ?></td>
                        <td>
                          <?php echo $rowdatacustomer['webtracking_tms_customer_address'] ?> <br>
                          <a href="http://maps.google.com/?q=<?php echo $rowdatacustomer['webtracking_tms_customer_lat']. "," .$rowdatacustomer['webtracking_tms_customer_lng'] ;?>" target="_blank">
                            <?php echo $rowdatacustomer['webtracking_tms_customer_lat']. "," .$rowdatacustomer['webtracking_tms_customer_lng'] ;?>
                          </a>
                        </td>
                        <td>
                          <a type="button" class="btn btn-primary" href="<?php echo base_url();?>tms/tms_customer_edit/<?php echo $rowdatacustomer['webtracking_tms_customer_id'];?>" title="Edit Data">
                            <span class="fa fa-edit"></span>
                          </a>

                          <button type="button" class="btn btn-danger" onclick="btnDelete('<?php echo $rowdatacustomer['webtracking_tms_customer_id'];?>')" title="Delete Data">
      ...
      <div class="col-md-12" id="formaddcustomermaster" style="display: none;">
        <div class="card-box">
          <div class="card-header">
            Add Customer
          </div>
          ...
          <div class="card-body">
            <form class="form-horizontal" action="<?php echo base_url()?>tms/savecustomer" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <input type="number" class="form-control" id="customer_phone" name="customer_phone" placeholder="Customer Name">
                  </div>
              </div>
...
<div id="modalDeleteCustomer" style="display: none;">
  <div id="mydivheader"></div>
  <div class="row" >
    <div class="col-md-12">
        <div class="card card-topline-yellow">
            <div class="card-head">
                <header>Delete Customer Data</header>
                <div class="tools">
                    <a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
                  <a class="t-collapse btn-color fa fa-chevron-down" href="javascript:;"></a>
                  <button type="button" class="btn btn-danger" name="button" onclick="closemodallistcustomer();">X</button>
                </div>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="<?php echo base_url()?>tms/deletecustomer" method="post" enctype="multipart/form-data">
...
function showaddtmscustomer(){
  $("#formaddcustomermaster").show();
  $("#formtablecustomermaster").hide();
}
...
function btnDelete(id){
  $("#iddelete").val(id);
  $("#modalDeleteCustomer").show();
}

function closemodallistcustomer(){
  $("#modalDeleteCustomer").hide();
}
