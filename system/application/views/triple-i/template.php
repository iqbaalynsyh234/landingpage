...
<meta name="google-site-verification" content="TvgB-1A56P-JtCDlsIhWa3oOk5TW7qsD8X5N3oqu2JY" />
		<title>TRIPLE-I FMS SYSTEM</title>
		...
		<?php } ?>
		<link media="screen" rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/triple-i/css/login.css"  />
		<script src="<?php echo base_url();?>assets/triple-i/js/jquery-1.7.1.min.js" type="text/javascript"></script>
