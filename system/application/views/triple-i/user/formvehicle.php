	...
	jQuery.maxZIndex = jQuery.fn.maxZIndex = function(opt) {
        ...
        function loadgroup()
        {
			...
			<tr id="trowner">
    			...
    			<tr>
						<td style="display:none";><?=$this->lang->line("lodometer_init");?></td>
						<td style="display:none";>:</td>
						<td style="display:none";><input type='text' name="vehicle_odometer" id="vehicle_odometer"  class="formshort" value="<?php if (isset($vehicle)) { echo $vehicle->vehicle_odometer; } ?>"  maxlength='9'> <?php echo $this->lang->line('lkm'); ?></td>
					</tr>
    			<tr>
