					...
					<table width="100%" cellpadding="3" class="tablelist">
						...
						?>
							<tr <?=($i%2) ? "class='odd'" : "";?> id="tr<?=$data[$i]->vehicle_id;?>">
								...
								<?php } ?>
								<span id="speed<?=$data[$i]->vehicle_id;?>" style=""></span>
								<?php if ($this->sess->user_type == 1) { printf("<br />(%s)", $data[$i]->vehicle_type); } ?></font></td>
								<?php } ?>
								
								<?php if ($this->sess->user_type == 1) { printf("<br />(%s)", $data[$i]->vehicle_type); } ?></td>																							
								<td>
								...
								<td style="text-align: left;" valign="top">
									<div style="position: absolute; ">GPS </div> <div style="position: relative; left : 20%;" id="signal<?=$data[$i]->vehicle_id;?>">-</div>
									<?php if (in_array(strtoupper($data[$i]->vehicle_type), $this->config->item("vehicle_gtp"))) { ?>
