        ...
        function init() 
        {
			...
			var	tiles_bgrnd = "http://osm.navigasi.net/background/";
			...
			var	tiles_navnet = "http://osm.navigasi.net/navnet-hybrid/";
			...
			tile_navnet.setOpacity(1);                  
 			...
 			<?php } else { ?>
 			map.addLayers([tile_bgrnd, tile_navnet, gmap, gphy, ghyb, roadatlas, gmap]);
            ...
            map.setCenter(new OpenLayers.LonLat(118.112640381, -2.06358572).transform(
                ...
                ), <?php echo (isset($ishistory) && $ishistory) ? $this->config->item("zoom_poi") : 5; ?>);                                    
		...
		{				
			...
			poilayer.displayInLayerSwitcher = true;															
