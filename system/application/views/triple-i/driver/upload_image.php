	...
	<table>
		<tr>
			<td>
				...
				<?php } else { ?>
					<img src="<?php echo base_url().$this->config->item("dir_photo").$row_image->driver_image_client_name;?>" width="256px" height="256px" />
				<?php } ?>
			</td>
			<td>
				...
				<input type="button" value="Cancel" onclick="location='<?php echo base_url();?>transporter/driver';" /> 
				<br /><br />
