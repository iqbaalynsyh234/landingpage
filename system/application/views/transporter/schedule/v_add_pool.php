...
<script>
	...
	{
		jQuery("#loader").show();
		jQuery.post("<?=base_url()?>projectschedule/save_pool", jQuery("#frmadd").serialize(),
			function(r)
			{
...
<!-- <?php echo $this->sess->user_id; ?> -->
	<div id="main" style="margin: 20px;">
      ...
      [ <a href="<?=base_url();?>projectschedule/pool_list"><font color="#0000ff">Pool List</font></a> ] <br><br>
      <table class="table tablelist" cellpadding="3">
        <tr>
          <td>Pool Name *</td>
          <td>:</td>
          <td>
            <input type="text" name="pool_name" id="pool_name" class="form-control" required>
          </td>
        </tr>
