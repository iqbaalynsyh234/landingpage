        ...
        <h1>Add Driver</h1>
			<table width="100%" cellpadding="3" class="table sortable no-margin">
				...
				<tr>
					<td>ID Card</td>
					<td>:</td>
					<td><input type="text" name="driver_idcard" /></td>
				</tr>
				<tr>
					<td>Address</td>
					<td>:</td>
				...
				<tr>
					...
					<td>:</td>
					<td>
						<input type="text" maxlength="15" name="driver_licence_expired" id="driver_licence_expired" class="date-pick" /><br />
					</td>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>:</td>
					<td>
						<input type="text" maxlength="15" name="driver_siof" id="driver_siof" /><br />
				...
				<tr>
					...
					<td>:</td>
					<td>
						<input type="text" maxlength="15" name="driver_siof_expired" id="driver_siof_expired" class="date-pick" /><br />
						<small>Surat Ijin Operation Forklip</small>
					</td>
					</td>
				</tr>
