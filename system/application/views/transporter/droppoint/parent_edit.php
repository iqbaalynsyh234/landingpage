...
<table width="100%" cellpadding="3" class="table sortable no-margin">
	<tr>
		...
		<input type="hidden" name="id" id="id" value="<?=isset($row) ? htmlspecialchars($row->parent_id, ENT_QUOTES) : "";?>" />
	</tr>
	<tr>
		<td colspan="2">Name</td>
		<td>:</td>
		<td><input type="text" name="name" id="name" value="<?=isset($row) ? htmlspecialchars($row->parent_name, ENT_QUOTES) : "";?>" />
	</tr>
	<tr>
		<td colspan="2">Code</td>
		<td>:</td>
		<td><input type="text" name="code" id="code" value="<?=isset($row) ? htmlspecialchars($row->parent_code, ENT_QUOTES) : "";?>" />
	</tr>
	<tr>
