<script>
	...
	function page(p)
	{
		...
		jQuery("#loader").show();
		jQuery.post("<?=base_url();?>operational_report/result_pto/", jQuery("#frmsearch").serialize(),
			function(r)
			{
				if (r.error) {
					alert(r.message);
...
function company_onchange(){
		...
		if(data_company == 0){
			...
			var site = "<?=base_url()?>operational_report/get_vehicle_pto_by_company/" + data_company;
		    jQuery.ajax({
		        url: site,
	...
	<div class="block-border">
        ...
        <h1>PTO Operational Report</h1>
			...
			<?php } ?>
				...
				<tr>
					<td style="border: 0px;"><input type="checkbox" name="checkdetail" id="checkdetail" value="1" checked /> View Detail <br /><small>ON < 1 menit</small></td>
		...
		<br />
		Note: Maksimal report yang tersedia sampai dengan hari kemarin. Untuk Report hari ini silahkan klik <b> <a href="<?=base_url();?>report/mn_pto_status" />PTO Daily Report</a></b>
		<br />
		<div id="result"></div>	
