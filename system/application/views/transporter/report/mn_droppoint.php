<script>
	...
	function page(p)
	{
		...
		jQuery("#loader2").show();
		jQuery.post("<?=base_url();?>report_droppoint/search/", jQuery("#frmsearch").serialize(),
			function(r)
			{
				jQuery("#loader2").hide();
				if (r.error)
...
<?=$navigation;?>
	...
	<div class="block-border">
        ...
        <h1>Droppoint Report</h1>
			...
			<table width="40%" cellpadding="3" class="tablelist" style="font-size: 12px;">
			
				<tr>
					<td>Type</td>
					<td>
						<input name="type" type="radio" checked value="0">REGULAR</input>
