...
<?=$navigation;?>
	...
	<div class="block-border">
		...
		<form action="<?=base_url();?>report/tripmileage_report_kml" method="post" class="block-content form" name="frmsearch" id="frmsearch">
		
			<h1>Trip Mileage Report to Data KML</h1>
				...
				<table width="100%" cellpadding="3" class="tablelist" style="font-size: 12px;">
					...
					<tr>
						...
						<td style="border: 0px;"><input class="btn_search2" id="btnsearchreport" type="submit" value="Export Data KML" />
