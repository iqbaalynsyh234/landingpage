	...
	-->
		...
		<header>
			<div class="container_12">
				<p id="skin-name"><small>Heavy Equipment Management System</small>
				&nbsp; 
				<strong>
			...
			<?php if ($this->sess->user_type != 4)  { ?>
				...
				<li id="write_active" class="write current" style="display: none;">
			        ...
			        <ul class="subnav"> 
						...
						<li><a href="<?=base_url();?>report/mn_inout_geofence"><?="In Out Geofence";?></a></li>
						<li><a href="<?=base_url();?>report/mn_hourmeter"><?="Hourmeter";?></a></li>
 ...
 <!-- Status bar -->
	<div id="status-bar"><div class="container_12">
        ...
        <ul id="breadcrumb">
			<li>Live Support</li>
			<?php 
				if (base_url() == "http://transporter.gpsandalas.com/" || base_url() == "http://www.transporter.gpsandalas.com/")
				{
			?>
			...
			?>
				<a href="ymsgr:sendIM?nedi_lacakmobil" class="button" title="Nedi">
           			...
           			<a href="ymsgr:sendIM?anto_lacakmobil" class="button" title="Anto">
            			...
            			<a href="ymsgr:sendIM?hadi_lacakmobil" class="button" title="hadi">
				...
				<a href="ymsgr:sendIM?ayu_lacakmobil" class="button" title="Ayu">
