...
<script type ="text/javascript" src="<?php echo base_url();?>assets/js/jsblong/epoly.js"></script>
	...
	var legs = response.routes[0].legs;
        for (i=0;i<legs.length;i++) {
          if (i == 0) { 
            ...
            marker = createMarker(legs[i].start_location,"Location",legs[i].start_address,"green");
          }
