...
{
  jQuery("#loader").show();
  jQuery.post("<?=base_url()?>projectschedule/update_project", jQuery("#frmadd").serialize(),
    function(r)
    {
      jQuery("#loader").hide();
      var status = r.status;
        ...
        <div class="col-sm-12">
          <div class="panel">
            ...
            <div class="panel-body">
              ...
              <a href="<?=base_url();?>projectschedule"><font color="#0000ff">Project List</font></a> <br>
              <table class="table tablelist" cellpadding="3">
                ...
                <tr>
                  ...
                  <td>:</td>
                  <td>
                    <input type="text" name="project_price" id="project_price" value="<?php echo $dataproject[0]['project_price'] ?>">
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>:</td>
                  <td>
                    <input type="text" name="project_startdate" id="project_startdate" value="<?php echo date("d-m-Y", strtotime($dataproject[0]['project_startdate'])) ?>">
                  ...
                  <td>:</td>
                  <td>
                    <input type="text" name="project_enddate" id="project_enddate" value="<?php echo date("d-m-Y", strtotime($dataproject[0]['project_enddate']))?>">
                    <select class="textgray" style="font-size: 11px; width: 65px;" id="ehour" name="ehour">
                                <option selected="" value="<?php echo date("H:i", strtotime($dataproject[0]['project_enddate']))?>"><?php echo date("H:i", strtotime($dataproject[0]['project_enddate']))?></option>
              ...
              <div id="mapnya">
                ...
                <table class="table">
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <input type="text" name="latitude" id="latitude" value="<?php echo $dataproject[0]['project_latitude'] ?>" readonly>
                    </td>
                    <td>Longitude</td>
                    <td>:</td>
                    <td>
                      <input type="text" name="longitude" id="longitude" value="<?php echo $dataproject[0]['project_longitude'] ?>" readonly>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <textarea name="addressfix" id="addressfix" rows="8" cols="80" readonly><?php echo $dataproject[0]['project_address'] ?></textarea>
                    </td>

                    <td>Radius</td>
                    <td>:</td>
                    <td>
                      <input type="text" name="allcordinates" id="allcordinates" value="<?php echo $dataproject[0]['project_radius'] ?>" readonly hidden>
                      <input type="text" name="allcordinatesforview" id="allcordinatesforview" value="<?php echo round($dataproject[0]['project_radius']) ?>" readonly> Mtr
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div style="text-align: right;">
                        <button type="submit" class="button">Update Data Project</button>
                      </div>
                    </td>
                  </tr>
                </table>
