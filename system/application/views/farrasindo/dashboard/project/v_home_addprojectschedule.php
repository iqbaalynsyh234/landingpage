...
{
  jQuery("#loader").show();
  jQuery.post("<?=base_url()?>project/save_project", jQuery("#frmadd").serialize(),
    function(r)
    {
      jQuery("#loader").hide();
      var status = r.status;
    ...
    circle.addListener('radius_changed', function(e){
        ...
        autocomplete.addListener('place_changed', function() {
          ...
          var data = {pool_no : pool_no};
            postData("<?php echo base_url()?>project/searchdatapool", data, function(err, response){
              if (err) {
                console.log("err : ", err);
                // console.log("response : ", response);
              }else {
                console.log("response : ", response);
                var latpool = parseFloat(response.data[0].poi_lat);
                var lngpool = parseFloat(response.data[0].poi_lng);
  ...
  <div class="page-content" id="newpagecontent">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="col-sm-12">
          <div class="panel">
            <header class="panel-heading panel-heading-blue">Add Project Schedule</header>
              ...
              <form class="block-content form" id="frmadd" onsubmit="javascript: return frmadd_onsubmit(this)">
                ...
                <table class="table listtable" cellpadding="3">
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <select class="select2" name="select_pool" id="select_pool" required>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <select class="select2" name="addschedule_vehicle" id="addschedule_vehicle" required>
                    ...
                    <td>:</td>
                    <td>
                      <select class="select2" name="addschedule_customer" id="addschedule_customer" required>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <select class="select2" name="addschedule_driver" id="addschedule_driver" required>
                    ...
                    <td>:</td>
                    <td>
                      <input class="form-control" type="text" name="project_price" id="project_price">
                    </td>
                  </tr>
                    ...
                    <td>
                      <div class="row">
                        <div class="input-group date form_date col-md-6" data-date="" data-date-format="dd-mm-yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                          <input class="form-control" size="10" type="text" readonly name="project_startdate" id="project_startdate" value="<?=date('d-m-Y')?>">
                        ...
                        <div class="input-group date form_date col-md-6" data-date="" data-date-format="dd-mm-yyyy" data-link-field="dtp_input2" data-link-format="dd-mm-yyyy">
                          <input class="form-control" size="10" type="text" readonly name="project_enddate" id="project_enddate" value="<?=date('d-m-Y')?>">
                          <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                          <input type="hidden" id="dtp_input2" value="" class="form-control"/>
  											</div>
                      </div>
                ...
                <input type="checkbox" name="showmap" id="showmap" onclick="toggleinmap();">Show Map For Location Project
                <br><br>
                <div id="mapnya" style="display: none;">
                ...
                <table class="table">
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <textarea class="form-control" name="addressfix" id="addressfix" rows="8" cols="50" readonly></textarea>
                    </td>

                    <td>Radius</td>
                    <td>:</td>
                    <td>
                      <input class="form-control" type="text" name="allcordinates" id="allcordinates" readonly hidden>
                      <input class="form-control" type="text" name="allcordinatesforview" id="allcordinatesforview" readonly> Mtr
                    </td>
                  </tr>
