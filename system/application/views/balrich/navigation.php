        ...
        <a name="atop"></a>
			...
			<?php if ($this->sess->user_type != 4)  { ?>
				...
				<li id="write_active" class="write current" style="display: none;">
			        ...
			        <ul class="subnav"> 
						...
						<li><a href="<?=base_url();?>balrich_report"><?="In Out Geofence Duration";?></a></li>
						<li><a href="<?=base_url();?>balrich_report/mn_dataoperasional"><?="Operational Report";?></a></li>
						<li><a href="<?=base_url();?>report/mn_door_status"><?="Door Status";?></a></li>
						<li><a href="<?=base_url();?>balrich_report/mn_histdoorstatus"><?="History Door Status";?></a></li>
						...
						<?php if ($this->sess->user_group == 0){ ?>
							<li><a href="<?=base_url()?>report_droppoint">Droppoint Report</a></li>
						<?php }?>
			        </ul> 
			    </li>
				...
				<?php echo "Manage"; ?></a>
			        <ul class="subnav">
						...
						<li><a href="<?=base_url();?>transporter/mod_vehicle_maintenance">Vehicle Information</a></li>
						<li><a href="<?=base_url();?>transporter/mod_vehicle_maintenance/service">Vehicle Maintenance</a></li>
			...
			-->
				...
				<ul>
			        	...
			        	<?php } ?>
						<?php if($this->sess->user_group == 0){ ?>
							<li><a href="<?=base_url()?>droppoint/dataparent">Group</a></li> 
							<li><a href="<?=base_url()?>droppoint/distrep">Distrep</a></li> 
							<li><a href="<?=base_url()?>droppoint">Droppoint</a></li> 
						<?php } ?>
...
<!-- END OF MAIN MENU --> 
 <!-- Status bar -->
	<div id="status-bar"><div class="container_12">
        ...
        <ul id="breadcrumb">
			<li>WhatsApp</li>
			<a href="#" class="button" title="Monitoring WhatsApp">
       	       <b>08558208484</b>
			</a>
		</ul>
		<ul id="breadcrumb">
			<li>BBM</li>
			<a href="#" class="button" title="Monitoring BBM">
       	       <b>7BEB76FB</b>
			</a>
		</ul>
		<ul id="breadcrumb">
