			...
			<?php if ($this->sess->user_type != 4)  { ?>
				...
				<li id="write_active" class="write current" style="display: none;">
			        ...
			        <ul class="subnav"> 
						...
						<li><a href="<?=base_url();?>report/mn_history_trip_mileage_kml"><?="Export Trip Mileage KML";?></a></li>
						<li><a href="<?=base_url();?>tcont_report/mn_history_trip_mileage"><?="History Trip Mileage";?></a></li>
				...
				<?php echo "Manage"; ?></a>
			        <ul class="subnav">
						...
						<li><a href="<?=base_url();?>tcont_jobfile"><?php echo "Job File" ?></a></li>
