...
<table width="100%" cellpadding="3" class="table sortable no-margin" style="margin: 3px;">
			...
			?>
				<tr <?=($i%2) ? "class='odd'" : "";?>>
					...
					<td>
                        <a href="<?=base_url();?>download/download_trip/<?=$data[$i]->autoreport_id;?>"><img src="<?=base_url();?>assets/newfarrasindo/images/downarrow.png" border="0" alt="Download" title="Download"></a>
