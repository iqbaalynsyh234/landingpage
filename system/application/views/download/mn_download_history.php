<script>
    ...
    {        
        ...
        jQuery.post("<?=base_url()?>download/history_report_available/"+p, jQuery("#frmsearch").serialize(), 
            function(r)
            {
	...
	<div id="main" style="margin: 20px;">
		<div class="block-border">
		    <form class="block-content form" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">	
                <h1><?php echo "History Report Download Available :";?> (<span id="total"></span>)</h1>
