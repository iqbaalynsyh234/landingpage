...
<?php } ?>		
		...
		function getAlarm()
		{
			...
			jQuery.post("<?=base_url()?>alarm/getcount", {},
				function(r)
				{
					...
					jQuery("#dvblacklistalert").html(r.blacklistlink);
		...
		function get_alert_blacklist()
		{
			jQuery.post('<?=base_url()?>carmanagement/tenant_blacklist', {},
				function(r)
				{   
				}
			);
        ...
        switch (v)
        {
            case "inactive":
				...
				jQuery("#rentcar_active").hide();
                jQuery("#rentcar_inactive").show();
            break;    
            case "active":
		...
		function mnrentcar(v)
        {
            switch(v)
            {
            case "inactive":
				jQuery("#rentcar_active").show();
				jQuery("#rentcar_inactive").hide();
				jQuery("#download_active").hide();
				jQuery("#download_inactive").show();
                jQuery("#alert_active").hide();
                jQuery("#alert_inactive").show();
			...
			<?php if ($this->sess->user_type != 4)  { ?>
				...
				<li id="write_active" class="write current" style="display: none;">
			        ...
			        <ul class="subnav"> 
						...
						<li><a href="<?=base_url();?>report/tool_move_data_gps">TOOl MOVE DATA GPS</a></li>
						<li><a href="<?=base_url();?>report/tool_move_data_info">TOOL MOVE DATA INFO</a></li>-->
			        </ul> 
			    </li>
				...
				<!-- menu rent car -->
				<li class="cars" id="rentcar_inactive">
					<a href="javascript:mnrentcar('inactive')" title="Rentcar"><?=$this->lang->line("lmanage_car"); ?></a>
				</li>
				<li class="cars current" id="rentcar_active" style="display : none" >
				<a href="javascript:mnrentcar('active')" title="Rentcar">
				<?php echo "rentcar"; ?></a>
			        <ul class="subnav">
                        <li><a href="<?php echo base_url(); ?>carmanagement/data_tenant"><?php echo "Data Penyewa" ?></a></li>
						<li><a href="<?php echo base_url(); ?>carmanagement/tenant_blacklist"><?php echo "Data Penyewa Blacklist" ?></a></li>
						<li><a href="<?php echo base_url(); ?>carmanagement/status_vehicle"><?php echo "Status Vehicle" ?></a></li>
						<!--<li><a href="<?php echo base_url(); ?>rentcar_vehicle"><?php echo "Vehicle Information" ?></a></li>-->
						<!--<li><a href="<?php echo base_url(); ?>carmanagement/data_report"><?php echo "Data Report" ?></a></li>-->
 ...
 <!-- Status bar -->
	<div id="status-bar"><div class="container_12">
		...
		<ul id="status-infos">
			...
			<li class="spaced"></li>
			<li>
				<a href="<?php echo base_url();?>carmanagement/tenant_blacklist/" class="button" title="Tenant Blacklist">
                <img src="<?php echo base_url();?>assets/newfarrasindo/images/icons/fugue/balloon.png" width="16" height="16" /> 
                <label id="dvblacklistalert"><font color='#7B68EE'><?php echo "Penyewa Blacklist"; ?></font></label></a>
       ...
       <ul id="breadcrumb">
			<li>Live Support</li>
            <a href="ymsgr:sendIM?nedi_lacakmobil" class="button" title="Nedi">
            <img  border="0" src="http://opi.yahoo.com/online?u=nedi_lacakmobil&amp;m=g&amp;t=1"/>
            </a>
            <a href="ymsgr:sendIM?anto_lacakmobil" class="button" title="Anto">
            <img border="0" src="http://opi.yahoo.com/online?u=anto_lacakmobil&amp;m=g&amp;t=1"/>
			</a>
			<a href="ymsgr:sendIM?rico_lacakmobil" class="button" title="Rico">
            <img border="0" src="http://opi.yahoo.com/online?u=rico_lacakmobil&amp;m=g&amp;t=1"/>
			</a>
			<a href="ymsgr:sendIM?bayu_lacakmobil" class="button" title="Bayu">
            <img border="0" src="http://opi.yahoo.com/online?u=bayu_lacakmobil&amp;m=g&amp;t=1"/>
			</a>
			<a href="ymsgr:sendIM?robi_lacakmobil" class="button" title="Robi">
