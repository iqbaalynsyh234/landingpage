...
var interval_request_pending_alert = <?php echo $this->config->item("interval_request_pending_alert");?>;	
var interval_request_confirm_alert = <?php echo $this->config->item("interval_request_confirm_alert");?>;	
...
setInterval("get_alert_request_pending();", interval_request_pending_alert);
setInterval("get_alert_request_confirm();", interval_request_confirm_alert);
...
function get_alert_request_pending()
{
	jQuery.post('<?=base_url()?>transporter/pgn_carpool/total_request_pending',{},
	function(r)
	{   
		jQuery("#dvrequestpending").html(" " + "(" + r.total + ")");
	}
	, "json"
	);
}
function get_alert_request_confirm()
{
	jQuery.post('<?=base_url()?>transporter/pgn_carpool/total_request_confirm',{},
	function(r)
	{   
		jQuery("#dvrequestconfirm").html(" " + "(" + r.total + ")");
	}
	, "json"
	);
}
        ...
        <a name="atop"></a>
			...
			-->
				...
				<ul>
			            ...
			            <?php } ?>
						<li><a href="<?=base_url()?>transporter/pgn_carpool/mn_request">Car Request</a></li>
 ...
 <!-- Status bar -->
	<div id="status-bar"><div class="container_12">
		...
		<ul id="status-infos">
			...
			<li class="spaced"></li>
            <li>
				<a href="<?=base_url()?>transporter/pgn_carpool/mn_request" class="button" title="Request(Pending)">
                <img src="<?php echo base_url();?>assets/newfarrasindo/images/icons/fugue/balloon.png" width="16" height="16" /> 
				Request(Pending)
                <label id="dvrequestpending"></label></a>
			</li>
			<li>
				<a href="<?=base_url()?>transporter/pgn_carpool/mn_request" class="button" title="Request(Confirm)">
                <img src="<?php echo base_url();?>assets/newfarrasindo/images/icons/fugue/balloon.png" width="16" height="16" /> 
				Request(Confirm)
                <label id="dvrequestconfirm"></label></a>
			</li>
            <!-- Geofence Alert -->
            <!--
            <li class="spaced"></li>
        ...
        <ul id="breadcrumb">
			<li>Live Support</li>
				...
				<a href="ymsgr:sendIM?ayu_lacakmobil" class="button" title="Ayu Lacakmobil">
