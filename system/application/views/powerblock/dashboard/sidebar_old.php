...
<div class="sidemenu-container navbar-collapse collapse fixed-menu">
	                <div id="remove-scroll">
	                    <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
							...
							<li class="nav-item">
	                            <a href="#" class="nav-link nav-toggle"> <i class="material-icons">map</i>
	                            ...
	                            <ul class="sub-menu">
									...
									<li class="nav-item">
										<a href="<?=base_url();?>tripreport/history" class="nav-link">
	                                        ...
	                                        <span class="title">History Summary</span>
	                            ...
	                            <ul class="sub-menu">
									<li class="nav-item">
										<a href="<?=base_url();?>fib" class="nav-link">
											<span class="title">FIB Dashboard</span>
										</a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="<?=base_url();?>pbimanage" class="nav-link ">
											<span class="title">SJ List</span>
	                                    </a>
	                                </li>
