...
jQuery(document).ready(
		function()
		{
			jQuery("#export_xcel2").click(function() 
			{ 
				window.open('data:application/vnd.ms-excel,' + encodeURIComponent(jQuery('#isexport_xcel2').html()));
			});
		}
	);
			...
			<header class="panel-heading panel-heading-red">RESULT</header>
				...
				<div class="row">	
						<div class="col-lg-4 col-sm-4">			
							<a href="javascript:void(0);" id="export_xcel2" type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-info"><small>Export to Excel</small></a>
						</div>
					</div>
				</div>
				<div id="isexport_xcel2">
				<div class="panel-body" id="bar-parent10">
					<div class="row">	
						<div class="col-lg-12 col-sm-12">					
						
							<tr>
								<td style="text-align:center;">SJ NO : <b><?php echo $sj_no;?></b></td>	
								<td style="text-align:center;">DI NO : <b><?php echo $sj_di_no;?></b></td>	
							</tr> 
							<br />
							<tr>
								<td style="text-align:center;">Vehicle : <b><?php echo $vehicle_no;?></b></td>	
								<td style="text-align:center;">Driver : <b><?php echo $sj_driver;?></b></td>	
							</tr> 
							<br />
							<tr>
								<td style="text-align:center;">Item : <b><?php echo $sj_item;?></b></td>	
								<td style="text-align:center;">Category : <b><?php echo $sj_category;?></b></td>	
							</tr> 
							<br />
							<tr>
								<td style="text-align:center;">SJ Created : <b><?php echo $startdate;?></b></td>	
								<td style="text-align:center;">SJ Completed : <b><?php echo $enddate;?></b></td>	
							</tr> 
							<br />
							<!--<tr>
