            ...
            <form class="form-horizontal form" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
              ...
              <table class="table" style="font-size:12px;">
                <tr>
                  ...
                  <td>
                    <input class="form-control" name="filterbygeofence" id="filterbygeofenceno" type="radio" value="" onClick="option_type_geofence('geofence_no')" checked>No</input>
                  </td>
                  <td>
                    <input class="form-control" name="filterbygeofence" id="filterbygeofence" type="radio" value="1" onClick="option_type_geofence('geofence_yes')">Yes</input>
                  </td>
                  <td>
                    <select name="thisgeofence" id="thisgeofence" class="select2" style="width: 100%;" disabled>
                      <?php
                ...
                <tr>
                  ...
                  <td>
                    <input class="form-control" name="notgeofence" id="notgeofenceno" type="radio" value="" onClick="option_type_not_geofence('not_geofence_no')" checked>No</input>
                  </td>
                  <td>
                    <input class="form-control" name="notgeofence" id="notgeofenceyes" type="radio" value="1" onClick="option_type_not_geofence('not_geofence_yes')">Yes</input>
                  </td>
                </tr>

                <tr>
                  <td><b>Filter By Geofence In PBI</b></td>
                  <td>
                    <input class="form-control" name="geofenceinpbi" id="geofenceinpbi" type="radio" value="" onClick="option_type_geofence('notinpbi')" checked>No</input>
                  </td>
                  <td>
                    <input class="form-control" name="geofenceinpbi" id="geofenceinpbi" type="radio" value="1" onClick="option_type_geofence('inpbi')">Yes</input>
                  </td>
                </tr>
              </table>
              <br>
              <table class="table" style="font-size:12px;">
                <tr>
                  ...
                  <td>
                    ...
                    <div class="input-group date form_date col-md-12" data-date-format="dd-mm-yyyy" data-link-format="dd-mm-yyyy">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div id="location_view" style="display:none"> Location Name:
                      <input class="form-control" type="text" name="location" id="location" value="" size="50" />
                    </div>
                  </td>
                  <td></td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div id="duration_view" style="display:none"> From:
                      <input class="form-control" type="text" name="s_minute" id="s_minute" value="" size="3" /> To:
                      <input class="form-control" type="text" name="e_minute" id="e_minute" value="" size="3" />
                    </div>
                  </td>
                  <td></td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div id="km_view" style="display:none">
                      From:
                      <input class="form-control" type="text" name="km_start" id="km_start" value="" size="3" placeholder="0~9" maxlength="3" checked/> KM To:
                      <input class="form-control" type="text" name="km_end" id="km_end" value="" size="3" placeholder="0~9" maxlength="3" /> KM
                    </div>
                  </td>
                  <td></td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div id="km_view" style="display:none">
                      From:
                      <input class="form-control" type="text" name="km_start" id="km_start" value="" size="3" placeholder="0~9" maxlength="3" /> KM To:
                      <input class="form-control" type="text" name="km_end" id="km_end" value="" size="3" placeholder="0~9" maxlength="3" /> KM
                    </div>
                  </td>
                  <td></td>
              ...
              <div class="text-right">
                ...
                <!-- <input class="btn_export" type="button" name="excel" id="export_xcel" value="Export To Excel"/> -->
                <input class="btn btn-success" type="button" name="btngotohistorymaps" id="btngotohistorymaps" value="History Maps" onclick="javascript:return gotohistorymaps()"/>
...
<script>
  ...
  function page(p) {
    ...
    jQuery("#loader").show();
    console.log("isgeofenceclicked : ", isgeofenceclicked);
			if (isgeofenceclicked == 1) {
				jQuery.post("<?=base_url();?>pbi_operationalreport/getdataoperationalbygeofence/", jQuery("#frmsearch").serialize(),
					function(r) {
				...
				jQuery.post("<?=base_url();?>pbi_operationalreport/getdataoperationalbynotgeofence/", jQuery("#frmsearch").serialize(),
					function(r) {
						// jQuery("#btngotohistorymaps").show();
						jQuery("#loader").hide();
						jQuery("#result").html(r.html);
        ...
        jQuery.post("<?=base_url();?>pbi_operationalreport/getdatabygeofencinpbi/", jQuery("#frmsearch").serialize(),
					function(r) {
        ...
        alert(isgeofenceclicked +"notinpbi");
				...
				jQuery.post("<?=base_url();?>pbi_operationalreport/dataoperational/", jQuery("#frmsearch").serialize(),
					function(r) {
						jQuery("#btngotohistorymaps").show();
						jQuery("#loader").hide();
						jQuery("#result").html(r.html);
  ...
  function gotohistorymaps() {
    jQuery("#loader2").show();
    jQuery.post("<?=base_url();?>pbi_operationalreport/newhistorymaps", jQuery("#frmsearch").serialize(),
      function(r) {
        jQuery("#loader2").hide();
        jQuery("#result").html(r.html);
      }, "json"
