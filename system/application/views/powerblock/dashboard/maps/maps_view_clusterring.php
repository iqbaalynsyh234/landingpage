...
<div class="page-content-wrapper">
  <div class="page-content">
        <button type="button" class="btn btn-primary" style="margin-left: 73%; z-index: 1; margin-top:1%; position: absolute;" title="Show Table" onclick="showtableperarea('<?php echo $companyid;?>')">
  ...
  function initialize(){
    ...
    if (datafixnya == "") {
     ...
     map = new google.maps.Map(document.getElementById('mapsnya'), {
       zoom: 8,
       center: {lat: parseFloat(obj[0].auto_last_lat), lng: parseFloat(obj[0].auto_last_long)}
     });
     ...
     for (var i = 0; i < obj.length; i++) {
       locationclusterr.push(
         {lat: parseFloat(obj[i].auto_last_lat), lng: parseFloat(obj[i].auto_last_long)}
       );
     }
     // console.log("locationclusterr : ", locationclusterr);
     ...
     marker = locationclusterr.map(function(location, i) {
    ...
    google.maps.event.addListener(markernya, 'click', function(evt){
      ...
      infowindow.close();
        var string = value.vehicle_no + ' - ' + value.vehicle_name + "<br>" +
          ...
          "Speed : " + value.gps.gps_speed + " kph" + "<br>" + "Engine : " + statusengine + "<br>" +
