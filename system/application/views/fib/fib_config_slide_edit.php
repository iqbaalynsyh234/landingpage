...
<div style="position: absolute; margin: 0; padding: 0; z-index: 1000; width: 100%;"> 
	...
	<div id="main" style="margin: 20px;">
		...
		<form name="frmadd" id="frmadd" onsubmit="javascript: return frmadd_onsubmit()">
			...
			<input type="hidden" name="fib_config_app_id" id="fib_config_app_id" value="<?php if(isset($row)){ echo $row->fib_config_app_id; } ?>"/>
			<table width="100%" cellpadding="3" class="tablelist">
				...
				<tr>
					...
					<td>:</td>
					<td><input type="text" name="fib_config_vehicle" id="fib_config_vehicle" value="<?=isset($row) ? htmlspecialchars($row->fib_config_vehicle, ENT_QUOTES) : "";?>"size = "10" class="form-control"/></td>
				</tr>
				<tr>
					<td>Status</td>
					<td>:</td>
