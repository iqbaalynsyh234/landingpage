...
function frmsearch_onsubmit()
	{
		...
		location = '<?php echo base_url();?>fibconfig/index/'+jQuery("#field").val()+"/"+jQuery("#keyword").val();
		return false;
	}
...
<div style="position: absolute; margin: 0; padding: 0; z-index: 1000; width: 100%;">
	...
	<div id="main" style="margin: 20px;">
		<br />&nbsp;
		<h1><?php echo "Config FIB Time List"; ?> (<?php echo $total;?>)</h1>
		...
		<!--[ <a href="<?php echo base_url();?>fibconfig/add"><font color="#0000ff"><?php echo $this->lang->line("ladd")." "."Config FIB"; ?></font></a> ]-->
		<p>
		<table width="100%" cellpadding="3" class="tablelist">
			<thead>
				<tr style="text-align:center">
					...
					<th style="text-align:center"><?php echo "Duration(s)" ?></td>
			...
			<tbody>
				...
				<tr <?=($i%2) ? "class='odd'" : "";?>>
					...
					<td valign="top" style="text-align:center;"><?=$data[$i]->fib_config_duration;?></td>
					...
					<td valign="top" style="text-align:center;">
						<a href="<?=base_url();?>fibconfig/edit/<?=$data[$i]->fib_config_id;?>">
