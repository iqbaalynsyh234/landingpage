...
<script>
	...
	function last_position_summary()
	{
		showdialog();
		jQuery.post('<?php echo base_url(); ?>/report/getvehicle',{},
		function(r)
		{
			showdialog(r.html, "Position Summary");
		}
		, "json"
		);
	}
					...
					<form class="block-content form" name="frmsearch" id="frmsearch" method="post" action="<?=base_url()?>trackers">
						...
						<fieldset class="grey-bg required">
							...
							<table width="100%" cellpadding="3" class="tablelist">
								...
								<tr>
									<td>
									<button type="button" class="red" onclick="javascript:last_position_summary()">Last Position Summary</button>
									</td>
								</tr>
							</table>
						</fieldset>
