<?php
		...
		$config['logout']                      = 'http://megabaja.lacak-mobil.com';
		$config['template']                    = 'megabaja/';
    ...
    $config['transporter_agent']         	 = 1;
		...
		$config["app_dosj"]                    = 0; // TRUE
		$config["app_megabaja"]                = 1; // TRUE
		$config["comment_app"]                 = 1;
		// $config['GOOGLE_MAP_API_KEY']          = "AIzaSyCfgBNhidINbKJELAwzCrVVBrePClgFLbo";
