...
$config['base_url']	= "http://localhost/transporter.abditrack.com/";
...
switch($servername)
{
	...
	break;
	case "megabaja.lacak-mobil.com":
		include "config.megabaja.php";
	break;
	case "megabaja.lacaktranslog.com":
		include "config.megabajatranslog.php";
	break;
	case "haleyora.lacak-mobil.com":
		include "config.haleyora.php";
	break;
	case "takari.lacak-mobil.com":
		include "config.takari.php";
	break;
}
