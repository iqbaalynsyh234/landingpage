...
class Geofencedatalive extends Base {
  ...
  function index(){
		...
		$this->params["content"]         = $this->load->view('dashboard/geofencelive/v_geofence', $this->params, true);
	...
	function manage($host, $name, $showlabel="")
	{
		...
		$this->params["sidebar"]         = $this->load->view('dashboard/sidebar', $this->params, true);
		$this->params["chatsidebar"]     = $this->load->view('dashboard/chatsidebar', $this->params, true);
		$this->params["contentgeofence"] = $this->load->view('dashboard/geofencelive/v_form', $this->params, true);
		$this->params["content"]         = $this->load->view('dashboard/geofencelive/v_main', $this->params, true);
		$this->load->view("dashboard/template_dashboard_report", $this->params);
