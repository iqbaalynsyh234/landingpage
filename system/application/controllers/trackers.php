...
class Trackers extends Base {
	...
	function trackersupdate()
	{
		...
		$this->params["data_autocheck"] = $rows_autocheck;
		// echo "<pre>";
		// var_dump($rows_autocheck);die();
		// echo "<pre>";
		$this->params["initmap"]        = $this->load->view('initmap', $this->params, true);
		$this->params["updateinfo"]     = $this->load->view('updateinfo', $this->params, true);
		$this->params["content"]        = $this->load->view('trackers/listforupdate', $this->params, true);
		$this->load->view("templatesess", $this->params);
	}

	function trackerspowerblock()
	{
		...
		$this->params["initmap"]        = $this->load->view('initmap', $this->params, true);
		$this->params["updateinfo"]     = $this->load->view('updateinfo', $this->params, true);
		$this->params["content"]        = $this->load->view('trackers/new_list', $this->params, true);
		$this->load->view("templatesess", $this->params);
	}
