...
class Euroasiatic extends Base {

	function Euroasiatic()
	{
		parent::Base();	
	...
	function operational($userid="", $startdate = "", $enddate = "")
    {
                            ...
                            foreach($val as $no=>$report)
                            {
                               ...
                               // {
								...
								if(isset($report['vehicle_name'])){
									...
									if($duration_sec > 29 ){
										$this->dbtrip = $this->load->database("euroasiatic_report",TRUE);
		...
		//Send Email
		$cron_name = "EUROASIATIC - OPERASIONAL REPORT";
		$this->dbtrip = $this->load->database("euroasiatic_report",TRUE);
...
";
	...
	function operational_other($userid="", $startdate = "", $enddate = "")
    {
		...
		//Send Email
		$cron_name = "EUROASIATIC - OPERASIONAL REPORT OTHER";
		$this->dbtrip = $this->load->database("euroasiatic_report",TRUE);
        $this->dbtrip->select("trip_mileage_id");
        $this->dbtrip->where("trip_mileage_start_time >=",$startdate);
        $this->dbtrip->where("trip_mileage_end_time <=",$enddate);
