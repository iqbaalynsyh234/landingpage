...
class Projectschedule extends Base {
	...
	function index(){
		...
		$this->params["content"] = $this->load->view('transporter/schedule/v_schedule', $this->params, true);
		$this->load->view("templatesess", $this->params);
	}

  // function searchschedule(){
  //   $this->params['orderby'] = "datanya masih kosong";
	//
	// 	$html = $this->load->view('transporter/schedule/v_schedule_list', $this->params, true);
	// 	$callback['html'] = $html;
  ...
  function add_project(){
    ...
    // echo "<pre>";
		$this->params["content"] = $this->load->view('transporter/schedule/v_add_schedule', $this->params, true);
		$this->load->view("templatesess", $this->params);
  }
    ...
    $this->params["driver"]   = $result3;
		...
		$this->params["content"] = $this->load->view('transporter/schedule/v_schedule_edit', $this->params, true);
		$this->load->view("templatesess", $this->params);
	}
    ...
    // var_dump($result);die();
    // echo "<pre>";
		$this->params["content"] = $this->load->view('transporter/schedule/v_pool_list', $this->params, TRUE);
		$this->load->view("templatesess", $this->params);
  }
    ...
    // var_dump($result);die();
    // echo "<pre>";
		$this->params["content"] = $this->load->view('transporter/schedule/v_add_pool', $this->params, TRUE);
		$this->load->view("templatesess", $this->params);
  }
	...
	function edit_pool($id){
		...
		$this->params["content"] = $this->load->view('transporter/schedule/v_pool_edit', $this->params, true);
		$this->load->view("templatesess", $this->params);
	}
    ...
    $obj 				= json_decode($json);
		$pool_no 		= $obj->pool_no;
		$getdata		= $this->m_projectschedule->getallpoolbyno("pool", "pool_no", $pool_no);
		// echo "<pre>";
