...
class Apilocal extends Base {
	...
	function lastposition()
	{
		...
		if(isset($postdata->Index) && isset($postdata->LimitVehicle)){
			$page = $postdata->Index * $postdata->LimitVehicle;
		...
		if(!isset($postdata->VehiclePlateNo) || $postdata->VehiclePlateNo == "")
		{
			...
			if($postdata->UserLevel == 1){
				...
				$this->db->where("vehicle_no",99999); //NO DATA
			}
