DROP FUNCTION t1_getAlertMaxSpeedStatus

================================

DELIMITER |

CREATE FUNCTION t1_getAlertMaxSpeedStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsmaxspeed_status INTO pstatus FROM webtracking_smsmaxspeed_t1 WHERE smsmaxspeed_vehicle = CONCAT(prname, '@', prhost) ORDER BY smsmaxspeed_created DESC LIMIT 1 OFFSET 0;
...
CREATE FUNCTION t1_pln_getAlertMaxSpeedStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsmaxspeed_status INTO pstatus FROM webtracking_smsmaxspeed_t1_pln WHERE smsmaxspeed_vehicle = CONCAT(prname, '@', prhost) ORDER BY smsmaxspeed_created DESC LIMIT 1 OFFSET 0;
...
DROP TRIGGER t1_pln_oninserted;
DELIMITER |
...
CREATE FUNCTION t3_getAlertMaxSpeedStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsmaxspeed_status INTO pstatus FROM webtracking_smsmaxspeed_t3 WHERE smsmaxspeed_vehicle = CONCAT(prname, '@', prhost) ORDER BY smsmaxspeed_created DESC LIMIT 1 OFFSET 0;
...
CREATE FUNCTION t4_farrasindo_getAlertMaxSpeedStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsmaxspeed_status INTO pstatus FROM webtracking_smsmaxspeed_t4_farrasindo WHERE smsmaxspeed_vehicle = CONCAT(prname, '@', prhost) ORDER BY smsmaxspeed_created DESC LIMIT 1 OFFSET 0;
...
DROP TRIGGER t4_farrasindo_oninserted;
DELIMITER |
...
CREATE FUNCTION indogps_getAlertMaxSpeedStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsmaxspeed_status INTO pstatus FROM webtracking_smsmaxspeed_indogps WHERE smsmaxspeed_vehicle = CONCAT(prname, '@', prhost) ORDER BY smsmaxspeed_created DESC LIMIT 1 OFFSET 0;
...
DROP TRIGGER indogps_oninserted;
DELIMITER |
...
CREATE TABLE `webtracking_smsmaxspeed_t4_farrasindo` (
...
CREATE TABLE `webtracking_smsmaxspeed_t3` (
  `smsmaxspeed_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsmaxspeed_vehicle` varchar(32) DEFAULT NULL,
  `smsmaxspeed_speed` double DEFAULT NULL COMMENT 'alert pada kecepatan berapa',
  `smsmaxspeed_max` double DEFAULT NULL COMMENT 'max kecepatan',
...
CREATE TABLE `webtracking_smsmaxspeed_t1` (
  `smsmaxspeed_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsmaxspeed_vehicle` varchar(32) DEFAULT NULL,
  `smsmaxspeed_speed` double DEFAULT NULL COMMENT 'alert pada kecepatan berapa',
  `smsmaxspeed_max` double DEFAULT NULL COMMENT 'max kecepatan',
...
CREATE TABLE `webtracking_smsmaxspeed_t1_1` (
  `smsmaxspeed_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsmaxspeed_vehicle` varchar(32) DEFAULT NULL,
  `smsmaxspeed_speed` double DEFAULT NULL COMMENT 'alert pada kecepatan berapa',
  `smsmaxspeed_max` double DEFAULT NULL COMMENT 'max kecepatan',
...
CREATE TABLE `webtracking_smsmaxspeed_t1_pln` (
  `smsmaxspeed_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsmaxspeed_vehicle` varchar(32) DEFAULT NULL,
  `smsmaxspeed_speed` double DEFAULT NULL COMMENT 'alert pada kecepatan berapa',
  `smsmaxspeed_max` double DEFAULT NULL COMMENT 'max kecepatan',
...
CREATE TABLE `webtracking_smsmaxspeed_indogps` (
  `smsmaxspeed_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsmaxspeed_vehicle` varchar(32) DEFAULT NULL,
  `smsmaxspeed_speed` double DEFAULT NULL COMMENT 'alert pada kecepatan berapa',
  `smsmaxspeed_max` double DEFAULT NULL COMMENT 'max kecepatan',
...
CREATE TABLE `webtracking_smsmaxspeed_hist` (
  `smsmaxspeed_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsmaxspeed_vehicle` varchar(32) DEFAULT NULL,
  `smsmaxspeed_speed` double DEFAULT NULL COMMENT 'alert pada kecepatan berapa',
  `smsmaxspeed_max` double DEFAULT NULL COMMENT 'max kecepatan',
...
DROP FUNCTION IsInside;

CREATE TABLE `webtracking_geofence` (
...
DROP FUNCTION IsInside;
DELIMITER |
CREATE FUNCTION IsInside(prname VARCHAR(32), prhost VARCHAR(32), prlat VARCHAR(16), prns CHAR(1), prlng VARCHAR(16), prew CHAR(1))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE id INT;
	DECLARE id1 INT;
	...
	SET lat = getLatitude(prlat, prns);
	SET lng = getLatitude(prlng, prew);
	
	SET @pt = CONCAT('POINT(', lat, ' ', lng, ')');

	SELECT geofence_id INTO id FROM webtracking_geofence WHERE geofence_vehicle = CONCAT(prname, '@', prhost) LIMIT 1 OFFSET 0;
	
	IF id IS NULL THEN
		RETURN -1;
	END IF;			
	
	SELECT geofence_id INTO id1 FROM webtracking_geofence WHERE CONTAINS(geofence_polygon, GEOMFROMTEXT(@pt)) AND geofence_vehicle = CONCAT(prname, '@', prhost) LIMIT 1 OFFSET 0;
	IF id1 IS NULL THEN
		RETURN 0;
	END IF;	
...
CREATE TABLE `webtracking_smsgeofence_t1` (
  ...
  `smsgeofence_geofence` int(11) DEFAULT NULL COMMENT 'fk ke table geofence',
...
CREATE TABLE `webtracking_smsgeofence_t1_1` (
  `smsgeofence_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsgeofence_time` timestamp NULL DEFAULT NULL,
  `smsgeofence_status` int(11) DEFAULT '1' COMMENT '1=keluar; 2=masuk',
  `smsgeofence_alert` int(11) DEFAULT '1' COMMENT '1=belum disms',
...
CREATE TABLE `webtracking_smsgeofence_t1_pln` (
  `smsgeofence_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsgeofence_time` timestamp NULL DEFAULT NULL,
  `smsgeofence_status` int(11) DEFAULT '1' COMMENT '1=keluar; 2=masuk',
  `smsgeofence_alert` int(11) DEFAULT '1' COMMENT '1=belum disms',
...
CREATE TABLE `webtracking_smsgeofence_t3` (
  `smsgeofence_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsgeofence_time` timestamp NULL DEFAULT NULL,
  `smsgeofence_status` int(11) DEFAULT '1' COMMENT '1=keluar; 2=masuk',
  `smsgeofence_alert` int(11) DEFAULT '1' COMMENT '1=belum disms',
...
CREATE TABLE `webtracking_smsgeofence_t4` (
  `smsgeofence_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsgeofence_time` timestamp NULL DEFAULT NULL,
  `smsgeofence_status` int(11) DEFAULT '1' COMMENT '1=keluar; 2=masuk',
  `smsgeofence_alert` int(11) DEFAULT '1' COMMENT '1=belum disms',
...
CREATE TABLE `webtracking_smsgeofence_t4_farrasindo` (
  `smsgeofence_id` int(11) NOT NULL AUTO_INCREMENT,
  `smsgeofence_time` timestamp NULL DEFAULT NULL,
  `smsgeofence_status` int(11) DEFAULT '1' COMMENT '1=keluar; 2=masuk',
  `smsgeofence_alert` int(11) DEFAULT '1' COMMENT '1=belum disms',
...
CREATE FUNCTION t1_getGeofenceStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsgeofence_status INTO pstatus FROM webtracking_smsgeofence_t1 WHERE smsgeofence_device = CONCAT(prname, '@', prhost) ORDER BY smsgeofence_time DESC LIMIT 1 OFFSET 0;
...
DELIMITER |
CREATE FUNCTION t1_pln_getGeofenceStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsgeofence_status INTO pstatus FROM webtracking_smsgeofence_t1_pln WHERE smsgeofence_device = CONCAT(prname, '@', prhost) ORDER BY smsgeofence_time DESC LIMIT 1 OFFSET 0;
...
DELIMITER |
CREATE FUNCTION t3_getGeofenceStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsgeofence_status INTO pstatus FROM webtracking_smsgeofence_t3 WHERE smsgeofence_device = CONCAT(prname, '@', prhost) ORDER BY smsgeofence_time DESC LIMIT 1 OFFSET 0;
...
DELIMITER |
CREATE FUNCTION t4_getGeofenceStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsgeofence_status INTO pstatus FROM webtracking_smsgeofence_t4 WHERE smsgeofence_device = CONCAT(prname, '@', prhost) ORDER BY smsgeofence_time DESC LIMIT 1 OFFSET 0;
...
DELIMITER |
CREATE FUNCTION t4_farrasindo_getGeofenceStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsgeofence_status INTO pstatus FROM webtracking_smsgeofence_t4_farrasindo WHERE smsgeofence_device = CONCAT(prname, '@', prhost) ORDER BY smsgeofence_time DESC LIMIT 1 OFFSET 0;
...
DELIMITER |
CREATE FUNCTION indogps_getGeofenceStatus(prname VARCHAR(32), prhost VARCHAR(32))
RETURNS INT DETERMINISTIC
BEGIN
	DECLARE pstatus INT;
	SELECT smsgeofence_status INTO pstatus FROM webtracking_smsgeofence_indogps WHERE smsgeofence_device = CONCAT(prname, '@', prhost) ORDER BY smsgeofence_time DESC LIMIT 1 OFFSET 0;
...
DELIMITER |
CREATE TRIGGER `t1_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps`
 FOR EACH ROW BEGIN	
		DECLARE lsignal INT;
...
DELIMITER |
CREATE TRIGGER `t4_farrasindo_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_farrasindo`
 FOR EACH ROW BEGIN	
		DECLARE lsignal INT;
...
DELIMITER |
CREATE TRIGGER `t4_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_gtp`
 FOR EACH ROW BEGIN	
		DECLARE lsignal INT;
...
DELIMITER |
CREATE TRIGGER `t4_new_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_gtp_new`
 FOR EACH ROW BEGIN	
		DECLARE lsignal INT;
...
DELIMITER |
CREATE TRIGGER `indogps_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_indogps`
 FOR EACH ROW BEGIN	
		DECLARE lsignal INT;
...
DELIMITER |
CREATE TRIGGER `t1_pln_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_pln`
 FOR EACH ROW BEGIN	
		DECLARE lsignal INT;
...
DELIMITER |
CREATE TRIGGER `t3_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_sms`
 FOR EACH ROW BEGIN	
		DECLARE lsignal INT;
...
DELIMITER |
CREATE TRIGGER `t1_1_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_t1_1`
 FOR EACH ROW BEGIN	
		DECLARE lsignal INT;
...
DELIMITER |
CREATE TRIGGER `t4_info_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_info_gtp`
 FOR EACH ROW BEGIN	
...
DELIMITER |
CREATE TRIGGER `t4_info_farrasindo_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_info_farrasindo`
 FOR EACH ROW BEGIN	
		IF NEW.gps_info_alarm_alert = '01' THEN
...
DELIMITER |
CREATE TRIGGER `t4_new_info_onbeforeinserted` BEFORE INSERT ON `webtracking`.`webtracking_gps_info_gtp_new`
 FOR EACH ROW BEGIN	
		IF NEW.gps_info_alarm_alert = '01' THEN
...
DROP TRIGGER t4_info_onbeforeinserted;
DROP TRIGGER t4_info_farrasindo_onbeforeinserted;
DROP TRIGGER t4_new_info_onbeforeinserted;
DROP TRIGGER t1_onbeforeinserted;
DROP TRIGGER t1_1_onbeforeinserted;
DROP TRIGGER t1_pln_onbeforeinserted;
DROP TRIGGER t3_onbeforeinserted;
DROP TRIGGER t4_onbeforeinserted;
DROP TRIGGER t4_farrasindo_onbeforeinserted;
DROP TRIGGER t4_new_onbeforeinserted;
DROP TRIGGER indogps_onbeforeinserted;
DROP TRIGGER t1_oninserted;
DROP TRIGGER t1_1_oninserted;
DROP TRIGGER t1_pln_oninserted;
DROP TRIGGER t3_oninserted;
DROP TRIGGER t4_oninserted;
