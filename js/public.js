...
function showErrorMessage(result, resultTip) {
	...
	case 96:	//RET_REGION_CODE_EXIST 96;	//行政区域编码已经被使用
		alert(_getRootFrameElement().lang.errRegionCodeExist);
		break;
	...
	case 102:	//密码强度较低
		...
		break;
	case 103:	//姓名已经存在
		alert(_getRootFrameElement().lang.name_existed);
		break;
	default:	//未知错误
...
//    	elementById.style.visibility ='hidden';
		...
		if(typeof _getRootFrameElement().lang != 'undefined' &&_getRootFrameElement().lang.langType == 'zh'){
